...
| Anglais          | 118 séries · 4 620 cartes · 10 dictées · 64 cours · A1→C2       | signalétique       |
| Espagnol         | 116 séries · 4 550 cartes · 10 dictées · 62 cours · A1→C2       | signalétique       |
...
des cartes : **1 155 en anglais, 1 138 en espagnol**. C'est le volume d'un B2
tenu ; un C1 complet demanderait encore le double. Les niveaux vont de A1 à **C2**, avec six séries
