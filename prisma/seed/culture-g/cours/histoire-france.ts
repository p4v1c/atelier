/** Histoire de France, premier lot — les cours. */
import type { LotCours } from "../commun";

export const COURS_HISTOIRE_FRANCE: LotCours = {
  "hf-merovingiens-rois": [
    ["Un royaume qu'on partage", `À la mort de Clovis en 511, son royaume est partagé entre ses quatre fils. Ce n'est pas un accident mais un principe : chez les Francs, le royaume est un patrimoine, et chaque succession le redécoupe. Toute la période mérovingienne s'explique par là.

Deux ensembles s'opposent durablement : l'Austrasie à l'est, autour de Metz, et la Neustrie à l'ouest, autour de Paris et Soissons. Leur rivalité prend un tour personnel avec deux reines devenues légendaires, Brunehaut, épouse du roi d'Austrasie, et Frédégonde, épouse du roi de Neustrie, dont la lutte occupe plusieurs décennies et se conclut par le supplice de Brunehaut.`],
...
En 751, Pépin le Bref franchit le pas. Il consulte le pape Zacharie, qui répond qu'il vaut mieux appeler roi celui qui détient le pouvoir : la caution pontificale rend le coup d'État acceptable. Le dernier Mérovingien, Childéric III, est tonsuré — la chevelure longue étant la marque de la royauté franque — et enfermé dans un monastère.`],
  ...
  "hf-charlemagne-empire": [
    ["Conquérir", `Charlemagne devient roi des Francs en 768 et passe l'essentiel de son règne en campagne. La plus longue est la guerre contre les Saxons : plus de trente ans de soumissions, de révoltes et de représailles, achevées par une conversion imposée et des déportations massives.

Le 25 décembre 800, à Rome, le pape Léon III le couronne empereur. Le geste restaure un titre impérial disparu en Occident depuis 476 et bouleverse l'équilibre avec Byzance, qui ne le reconnaîtra qu'après des années de négociation.`],
    ["Tenir", `Gouverner un tel espace sans administration permanente supposait des inventions. Les capitulaires sont les textes législatifs de Charlemagne, ainsi nommés parce qu'ils sont divisés en chapitres ; ils règlent aussi bien l'armée que la monnaie, l'Église ou l'agriculture.

Les missi dominici, envoyés du maître, circulent par deux — un laïc et un ecclésiastique — pour inspecter les comtés, entendre les plaintes et vérifier l'application des ordres. Charlemagne établit par ailleurs sa capitale à Aix-la-Chapelle, choix inhabituel pour un souverain jusque-là itinérant, et y fait bâtir une chapelle palatine encore debout.`],
    ["Écrire, puis se défaire", `La renaissance carolingienne accompagne l'entreprise politique. Le savant anglais Alcuin dirige l'école du palais et anime une réforme de l'enseignement et de la copie des textes. C'est de cet effort que sort la minuscule caroline, écriture claire et régulière qui facilite la lecture et dont dérivent nos minuscules d'imprimerie. Éginhard, autre lettré de la cour, rédige la Vita Karoli, première grande biographie médiévale d'un laïc.

L'empire ne survit pas trois générations. En 843, le traité de Verdun le partage entre les trois petits-fils de Charlemagne, dessinant des ensembles qui annoncent la France et l'Allemagne. Un an plus tôt, les serments de Strasbourg, prêtés entre deux de ces frères, nous ont laissé le plus ancien texte connu en langue romane.`],
  ],
...
En 1209, la croisade des albigeois est lancée contre les cathares du Languedoc : une croisade menée en pays chrétien, dont la conséquence politique majeure est le rattachement du Midi à la couronne de France. Enfin, la chute de Saint-Jean-d'Acre en 1291 met fin aux États latins d'Orient, deux siècles après l'appel de Clermont.`],
  ],
...
En juin, la victoire de Patay détruit une armée anglaise en rase campagne et ouvre la route de Reims. Le sacre y a lieu le 17 juillet 1429 : il est décisif parce qu'il fait de Charles VII le roi légitime aux yeux de tous, avec l'onction et le lieu qui font la royauté française. C'était l'objectif que Jeanne poursuivait depuis le début.`,
      { image: "hf-jeanne-darc", legende: "Jeanne d'Arc telle que le XIXe siècle l'a fixée dans l'imaginaire national : l'étendard, l'armure et le regard levé. Aucun portrait fait de son vivant ne nous est parvenu." }],
    ["Rouen, puis la réhabilitation", `Capturée à Compiègne en mai 1430 par les Bourguignons, Jeanne est vendue aux Anglais. Son procès s'ouvre à Rouen sous la présidence de Pierre Cauchon, évêque de Beauvais acquis à leur cause : c'est un procès d'Église, mais mené par des juges qui ne sont pas neutres.

Après avoir abjuré puis repris ses habits d'homme, elle est condamnée comme relapse et hérétique, et brûlée le 30 mai 1431. Il faut distinguer nettement ce procès de celui de 1456 : à la demande de sa famille et avec l'appui du roi, un procès en nullité annule alors la condamnation. Elle sera canonisée en 1920, près de cinq siècles plus tard.`],
  ],

  "hf-francois-premier": [
    ["Le roi guerrier", `François Ier remporte à Marignan, en 1515, une victoire éclatante dès la première année de son règne : elle lui donne le Milanais et une réputation durable.
...
À la mort de Mazarin, en 1661, Louis XIV annonce qu'il gouvernera seul, sans premier ministre. La décision surprend la cour, qui n'y croit pas. Elle tiendra cinquante-quatre ans, et l'expérience de la Fronde en explique largement l'esprit : concentrer le pouvoir, tenir la noblesse à la cour, et ne plus jamais dépendre d'un ministre unique.`],
  ],

  "hf-lumieres-france": [
    ["L'entreprise des Lumières", `L'Encyclopédie, dirigée par Denis Diderot et Jean Le Rond d'Alembert, paraît de 1751 à 1772 : dix-sept volumes de texte et onze de planches, plusieurs fois interdits et poursuivis. Son ambition est de rassembler tous les savoirs, y compris techniques, et de les soumettre à l'examen.

Deux ouvrages majeurs l'encadrent. De l'esprit des lois, de Montesquieu, paraît en 1748 et propose la séparation des pouvoirs comme garantie contre le despotisme. Le Contrat social, de Rousseau, paraît en 1762 et fonde la légitimité du pouvoir sur la volonté générale. Ces idées circulent dans les salons, où des femmes — Mme Geoffrin, Mme du Deffand, Julie de Lespinasse — organisent la sociabilité intellectuelle du siècle.`],
    ["Un royaume qui s'épuise", `La France sort affaiblie de la guerre de Sept Ans : au traité de Paris de 1763, elle perd le Canada et l'essentiel de ses comptoirs indiens. Quinze ans plus tard, elle s'engage dans la guerre d'indépendance américaine, victoire diplomatique mais gouffre financier qui achève de déséquilibrer les comptes.

Les tentatives de réforme échouent l'une après l'autre. Turgot, contrôleur général en 1774, veut libérer le commerce des grains et supprimer les corporations : il est renvoyé en 1776 sous la pression conjuguée des privilégiés et des émeutes frumentaires.`],
    ["Le blocage et la convocation", `Les parlements, cours de justice détenant l'enregistrement des édits royaux, s'opposent systématiquement aux réformes fiscales au nom des lois fondamentales du royaume. Souvent présentés comme des défenseurs des libertés, ils protègent d'abord les privilèges de leurs membres — mais ce blocage rend toute solution impossible sans convocation d'une assemblée.

Faute d'autre issue, Louis XVI convoque les états généraux pour mai 1789, pour la première fois depuis 1614. À cette occasion, les paroisses et les corporations rédigent des cahiers de doléances, qui adressent au roi leurs demandes : ils constituent une photographie exceptionnelle de la société française à la veille de la Révolution.`],
  ],

  "hf-symboles-republique": [
    ["Le drapeau et l'hymne", `Le drapeau tricolore est adopté en 1790 par l'Assemblée constituante : il associe le blanc du roi aux couleurs de Paris. Sa forme définitive, aux trois bandes verticales, est fixée en 1794.

La Marseillaise est composée en 1792 par Rouget de Lisle, officier en garnison à Strasbourg, comme chant de guerre pour l'armée du Rhin. Elle doit son nom aux fédérés marseillais qui l'entonnent en montant à Paris. Déclarée chant national en 1795, écartée sous l'Empire et la Restauration, elle ne devient définitivement hymne national qu'en 1879, sous la IIIe République — comme beaucoup de ces symboles, elle naît de la Révolution mais n'est officialisée qu'un siècle plus tard.`],
    ["Marianne, la devise, la fête", `Marianne représente la République française. Figure allégorique coiffée du bonnet phrygien, emprunté aux esclaves affranchis de Rome, elle apparaît pendant la Révolution et se diffuse surtout à partir de la IIIe République, dans les mairies et sur les timbres.

La devise Liberté, Égalité, Fraternité figure au fronton des mairies et à l'article 2 de la Constitution actuelle, aux côtés du drapeau, de l'hymne et du principe du gouvernement du peuple par le peuple. Le 14 Juillet devient fête nationale en 1880 : la loi ne précise pas si elle commémore la prise de la Bastille de 1789 ou la Fête de la Fédération de 1790, ambiguïté volontaire qui permettait de rallier les modérés.`],
    ["Emblèmes et lieux", `Le faisceau de licteur, présent sur les documents officiels et sur l'emblème de la République, symbolise l'union et l'autorité de l'État : les verges liées ensemble figurent la force du groupe, la hache le pouvoir de justice. Le coq gaulois, lui, n'a aucun statut officiel : il vient d'un jeu de mots latin entre gallus, le coq, et Gallus, le Gaulois, et s'est imposé par l'usage, notamment sportif.

Le Panthéon, à Paris, accueille les grands hommes de la Nation — et depuis peu, un peu moins rarement, les grandes femmes. Église Sainte-Geneviève à l'origine, il a changé plusieurs fois d'affectation au gré des régimes avant de devenir définitivement nécropole républicaine en 1885, à l'occasion des funérailles de Victor Hugo.`],
  ],

  "hf-outre-mer-histoire": [
    ["Les îles à sucre", `La Guadeloupe et la Martinique deviennent françaises en 1635, dans le cadre d'une colonisation de peuplement et de plantation. L'économie sucrière qui s'y développe repose sur la traite et le travail servile, et le Code noir de 1685 en fixe le cadre juridique.

L'esclavage est aboli une première fois en 1794, rétabli par Bonaparte en 1802, puis aboli définitivement par le décret du 27 avril 1848, obtenu par Victor Schœlcher, sous-secrétaire d'État à la Marine et aux Colonies. Cette date structure encore la mémoire et le calendrier commémoratif des outre-mer.`],
    ["De colonies à départements", `En 1946, la Réunion, la Martinique, la Guadeloupe et la Guyane cessent d'être des colonies et deviennent des départements français : c'est la départementalisation, réclamée par des élus locaux — dont Aimé Césaire — comme une revendication d'égalité des droits.

D'autres territoires ont suivi d'autres voies. La Nouvelle-Calédonie, dans le Pacifique, a connu après des affrontements graves les accords de Matignon en 1988, puis l'accord de Nouméa en 1998, qui organisait un transfert progressif de compétences et une série de référendums d'autodétermination. Mayotte, dans le canal du Mozambique, est devenue le cent unième département français en 2011.`],
    ["Trois océans", `L'outre-mer français s'étend sur trois océans. Saint-Pierre-et-Miquelon, au large de Terre-Neuve, est le dernier vestige de la Nouvelle-France en Amérique du Nord. La Guyane est le seul territoire français d'Amérique du Sud continentale, couvert à plus de quatre-vingt-dix pour cent de forêt. Les Terres australes et antarctiques françaises rassemblent des districts de l'océan Indien austral et une revendication en Antarctique, gelée par le traité de 1959.

Le point le plus élevé de l'outre-mer est le piton des Neiges, à La Réunion, qui dépasse trois mille mètres. La Martinique, elle, garde la mémoire d'une catastrophe : l'éruption de la montagne Pelée détruit en 1902 la ville de Saint-Pierre et tue près de trente mille personnes en quelques minutes.`],
  ],
...
Pendant la guerre, le programme du Conseil national de la Résistance prépare l'après : il prévoit un plan complet de sécurité sociale. La Sécurité sociale est créée par les ordonnances de 1945, avec l'ambition d'une couverture généralisée financée par les cotisations. En 1950 s'y ajoute le salaire minimum interprofessionnel garanti, premier salaire plancher légal.`],
    ["L'extension continue", `L'édifice s'étend ensuite par vagues successives. La retraite à soixante ans est instaurée en 1982, dans le cadre des réformes du début du septennat de François Mitterrand — elle sera reportée par les réformes ultérieures.

En 1988 est créé le revenu minimum d'insertion, premier minimum social ouvert à tous les adultes sans ressources et non liés à une catégorie particulière ; il deviendra le RSA en 2009. En 1999, la couverture maladie universelle achève de rattacher à l'assurance maladie ceux qui en restaient exclus faute de cotisations. Chacune de ces étapes répond au même constat : un système fondé sur l'emploi laisse dehors ceux qui n'en ont pas.`],
  ],
...
En politique, Édith Cresson est la première femme Première ministre en 1991, pour moins d'un an. La parité est inscrite dans la Constitution en 1999, ouvrant la voie aux lois imposant l'alternance des candidatures sur les listes électorales. Les effets sont nets aux élections de liste, beaucoup plus limités aux scrutins uninominaux, où les partis ont longtemps préféré payer des pénalités financières.`],
  ],

  "hf-monuments-france": [
    ["Ce qui change d'usage", `Beaucoup des grands monuments français ont changé de fonction — c'est même la règle plutôt que l'exception. Le Louvre est d'abord une forteresse construite par Philippe Auguste vers 1190, puis un palais royal, avant de devenir musée en 1793. Le Panthéon de Paris est édifié comme église dédiée à sainte Geneviève, avant d'être transformé en nécropole des grands hommes.

Les Invalides, eux, ont été construits sous Louis XIV pour accueillir les soldats blessés et vieillis — hôpital et maison de retraite militaire avant d'abriter le tombeau de Napoléon.`],
