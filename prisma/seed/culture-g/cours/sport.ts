/** Sport — cours couvrant les trois lots de notions. */
...
La Coupe Davis, créée en 1900, oppose des sélections nationales masculines ; elle a changé plusieurs fois de format depuis 2019. Côté droits, l'Américaine Billie Jean King a mené dans les années 1970 le combat pour l'égalité des primes entre femmes et hommes : l'US Open a cédé dès 1973, Wimbledon seulement en 2007.`],
    ["Les cousins du tennis", `Le badminton se joue avec un volant, dont la traînée aérodynamique interdit tout rebond : le volant ne touche jamais le sol tant que l'échange dure, ce qui produit les échanges les plus rapides de tous les sports de raquette.
...
Une équipe aligne cinq joueurs sur le terrain. Un panier vaut deux points, ou trois s'il est marqué au-delà d'une ligne courbe adoptée en NBA en 1979 : cette ligne a transformé la tactique du jeu bien plus que toute autre règle, en donnant une prime au tir lointain.`],
    ["Le rugby et la passe en arrière", `Le rugby à quinze aligne quinze joueurs, huit avants et sept arrières, dont quatre trois-quarts. Un essai vaut cinq points, la transformation qui le suit en ajoute deux. Le rugby à treize est un code distinct, né d'une scission de 1895 sur la question du remboursement des joueurs.
...
Le handball se joue à sept, dont un gardien, seul autorisé dans la zone de six mètres. La France y domine le handball international depuis le milieu des années 2000, avec plusieurs générations titrées aux championnats du monde, d'Europe et aux Jeux.`],
  ],
...
La Coupe de l'America est plus ancienne encore : disputée pour la première fois en 1851, elle est la plus ancienne compétition sportive internationale encore courue aujourd'hui. Son format singulier veut que le détenteur choisisse en partie les règles et le lieu de la défense de son titre, ce qui en fait autant un affrontement juridique et technologique que sportif.`],
  ...
  "sp-corps-performance": [
    ["Ce que consomme l'effort", `La VO2 max, consommation maximale d'oxygène, mesure le plafond de la filière aérobie ; elle s'exprime en millilitres par kilo et par minute et ne suffit pas à elle seule à prédire la performance.

L'effort prolongé puise dans deux réservoirs : le glycogène, abondant mais limité à une heure et demie d'exercice soutenu, et les graisses, quasi inépuisables mais lentes à mobiliser. Tout l'entraînement d'endurance consiste à apprendre au corps à préférer le second le plus longtemps possible — le fameux mur du marathonien n'est rien d'autre que l'épuisement du premier.
...
L'arbitre applique cette règle sur le terrain. Au football, il est assisté de deux officiels placés sur la touche, chargés notamment de signaler le hors-jeu, et d'un quatrième arbitre. La règle de l'avantage lui permet de ne pas siffler une faute lorsque l'équipe victime tire un bénéfice à poursuivre le jeu : sanctionner reviendrait alors à punir l'attaquant. Le temps additionnel compense les arrêts de jeu, sans jamais les rattraper exactement.`],
...
Les clubs du nord font sécession en 1895, puis modifient progressivement les règles pour rendre le jeu plus rapide et plus spectaculaire : treize joueurs à partir de 1906 seulement, mêlées non disputées, puis limitation du nombre de plaquages successifs. La division sociale à l'origine de la rupture explique encore aujourd'hui la géographie des deux codes.`],
...
Le rugby professionnel a vu plusieurs anciens joueurs développer des maladies neurodégénératives précoces, ce qui a conduit à des actions collectives contre les fédérations. Protocoles commotion obligatoires, retrait immédiat du joueur suspecté, abaissement de la hauteur de plaquage autorisée : le sport modifie ses règles plus vite qu'à aucun moment de son histoire.`],
    ["Les compétitions et la culture", `Le Tournoi des Six Nations oppose chaque année l'Angleterre, l'Écosse, le pays de Galles, l'Irlande, la France et l'Italie, cette dernière l'ayant rejoint en 2000. Réaliser le Grand Chelem, c'est battre les cinq autres équipes la même année. Avant leurs matchs, les All Blacks néo-zélandais exécutent un haka, danse rituelle maorie dont le Ka Mate est la version la plus connue.
...
Les sports à jeu continu, comme le football ou le handball, résistent pourtant à la modélisation statistique bien mieux que le baseball ou le basket, faits d'actions discrètes où l'analyse chiffrée a bouleversé les stratégies. La raison est structurelle : les interactions entre joueurs y sont trop nombreuses, trop simultanées et trop dépendantes du contexte pour être isolées. Une passe réussie dépend de vingt-deux positions, d'une trajectoire, d'un état de fatigue et d'une intention — que les données décrivent mal.`],
  ],
...
La pétanque fait exception par sa jeunesse : née à La Ciotat au début du XXe siècle, elle dérive du jeu provençal en supprimant l'élan — pieds tanqués, c'est-à-dire ancrés. Elle compte aujourd'hui des centaines de milliers de licenciés et prétend régulièrement à une reconnaissance olympique.`],
    ["Le Sud-Ouest et la Bretagne", `La pelote basque désigne une famille de jeux de balle contre un mur ou un fronton, avec des variantes se jouant à main nue, à la chistera — le gant d'osier — ou à la pala. Certaines de ses formes comptent parmi les jeux de balle les plus rapides du monde.
...
En quatre nages individuel, l'ordre est imposé : papillon, dos, brasse, nage libre. Il diffère de celui du relais quatre nages, qui commence par le dos — parce que le départ du dos se fait dans l'eau, ce qui interdit de le placer après un relais. Un bassin olympique mesure cinquante mètres ; les performances en petit bassin de vingt-cinq mètres font l'objet de records distincts, les virages y étant deux fois plus nombreux.`],
    ["Les grandes carrières", `Michael Phelps détient le record de médailles olympiques toutes disciplines confondues : vingt-huit, dont vingt-trois en or, sur quatre éditions des Jeux. Son total dépasse celui de la plupart des pays participants.
...
Au saut à la perche, le Suédois Armand Duplantis détient le record du monde, qu'il a relevé de centimètre en centimètre depuis 2020 — pratique liée aux primes attribuées à chaque record. Le Français Renaud Lavillenie l'avait précédé en battant en 2014, en salle, le record de Sergueï Bubka vieux de vingt et un ans. Le triple saut, lui, enchaîne trois bonds — cloche-pied, foulée bondissante, saut — avant la réception dans le sable.`],
    ["La longueur, et un record hors norme", `Le saut en longueur a connu l'un des records les plus étranges de l'athlétisme : à Mexico en 1968, Bob Beamon dépasse de cinquante-cinq centimètres le record du monde en un seul saut, à une altitude favorable et avec un vent maximal autorisé. La performance a tenu vingt-trois ans, jusqu'à Mike Powell en 1991 — dont le record tient toujours.

Ce cas illustre le rôle des conditions : altitude, vent, piste. Il rappelle aussi qu'un record exceptionnel peut geler une discipline pendant des décennies, en devenant une référence que la progression normale n'atteint pas.`],
    ["Les lancers", `Quatre engins, quatre gestes distincts. Le poids se pousse depuis l'épaule, sans mouvement de lancer. Le disque se lance après une rotation dans un cercle, geste immortalisé par le Discobole antique. Le marteau, boule métallique reliée à un câble et à une poignée, se lance après trois ou quatre tours ; il dérive d'une pratique traditionnelle celtique, où l'on lançait réellement un marteau de forgeron.

Le javelot se lance après une course d'élan, seul engin à en bénéficier. Son centre de gravité a été délibérément modifié en 1986 : les distances atteintes devenaient dangereuses pour les stades, les javelots dépassant les cent quatre mètres. Le nouveau modèle pique du nez plus tôt, ce qui a fait chuter les records d'une dizaine de mètres.`],
    ["Tout faire", `Le décathlon est une épreuve combinée masculine de dix disciplines réparties sur deux jours, avec un barème qui convertit chaque performance en points. Son équivalent féminin, l'heptathlon, en compte sept. Le vainqueur du décathlon olympique est traditionnellement salué comme le meilleur athlète du monde, formule qui traduit une réalité : il faut y être compétent en sprint, en saut, en lancer et en demi-fond.

Le Français Kévin Mayer détient le record du monde de la discipline depuis 2018, avec un titre de champion du monde et deux médailles d'argent olympiques — l'or lui ayant échappé de peu à deux reprises.`],
  ],

  "sp3-gymnastique": [
    ["Les agrès", `La gymnastique artistique figure au programme olympique depuis 1896, mais sous une forme très différente de l'actuelle — on y pratiquait aussi le grimper de corde et les sauts de cheval. Les concours masculins comptent aujourd'hui six agrès, les concours féminins quatre, répartition héritée du XIXe siècle et régulièrement discutée.

Deux logiques s'y opposent : force et suspension côté masculin, avec les anneaux et le cheval d'arçons ; équilibre et expression côté féminin, avec la poutre et le sol sur musique. Aucun agrès n'est commun aux deux programmes hormis le saut et le sol, et encore ce dernier diffère-t-il par la présence ou l'absence de musique.`],
    ["Noter l'inotable", `Le code de pointage est le règlement qui fixe la valeur des difficultés et le barème des pénalités. Révisé après chaque olympiade, il oriente directement l'évolution de la discipline : valoriser un type d'élément suffit à faire apparaître une génération de gymnastes qui s'y spécialise.

La note se décompose en deux : la note D évalue la difficulté du programme, sans plafond, en additionnant la valeur des éléments ; la note E part de dix et décompte les fautes d'exécution. Ce système a remplacé en 2006 la notation sur dix, dont Nadia Comăneci avait obtenu la première note parfaite aux Jeux de Montréal en 1976, à quatorze ans — l'affichage électronique, prévu pour trois chiffres seulement, avait indiqué 1,00.`],
    ["Simone Biles", `L'Américaine Simone Biles domine la discipline depuis 2013, avec un total de titres mondiaux et olympiques sans équivalent. Plusieurs éléments portent son nom au code de pointage, réservé aux gymnastes ayant réalisé une figure inédite en compétition internationale.

Sa décision de se retirer de plusieurs finales aux Jeux de Tokyo en 2021, en invoquant un trouble de perception spatiale en vol et sa santé mentale, a eu un retentissement considérable. Elle a déplacé le regard porté sur les athlètes de haut niveau, en légitimant publiquement le retrait pour raisons psychologiques dans un milieu qui valorisait l'endurance à la douleur.`],
    ["Ce que la discipline a dû affronter", `Depuis 2016, la gymnastique a affronté des affaires massives de violences sexuelles et de maltraitance. L'affaire Larry Nassar, médecin de la fédération américaine, a impliqué des centaines de victimes et révélé des défaillances institutionnelles à tous les niveaux ; des enquêtes comparables ont suivi au Royaume-Uni, aux Pays-Bas, en Belgique et en France.

Ces révélations ont nourri un mouvement plus large de libération de la parole dans le sport, où des athlètes ont dénoncé les violences subies et un système d'entraînement fondé sur la peur et le contrôle du corps de très jeunes filles. Les conséquences institutionnelles sont réelles : cellules de signalement indépendantes, contrôle de l'honorabilité des encadrants, révision des méthodes d'entraînement des mineurs. Le risque physique reste lui aussi élevé, la spécialisation précoce et les impacts répétés étant la première cause de blessure.`],
  ],
  "sp3-esport": [
    ["Un sport, vraiment ?", `Le sport électronique est la pratique compétitive du jeu vidéo, organisée en ligues, tournois et championnats. Il réunit des audiences comparables à celles de sports traditionnels : les finales des plus grandes compétitions dépassent régulièrement les dizaines de millions de spectateurs simultanés.

Son statut de sport fait débat, et pas seulement pour l'absence d'effort physique. Une difficulté plus structurelle tient au rôle des éditeurs : contrairement au football, dont personne ne possède les règles, chaque jeu appartient à une entreprise privée qui peut en modifier l'équilibre, en restreindre l'usage compétitif ou cesser de le maintenir. Un sport dont les règles sont la propriété d'une société pose au mouvement olympique un problème inédit.`],
    ["Les grandes compétitions", `League of Legends a longtemps dominé le sport électronique mondial ; son championnat du monde annuel réunit les meilleures équipes des différentes régions et remplit des enceintes sportives. The International, tournoi majeur de Dota 2, s'est distingué par des dotations record dépassant quarante millions de dollars, financées en grande partie par la communauté des joueurs via l'achat d'objets dans le jeu.

La Corée du Sud a longtemps dominé la discipline, pour des raisons documentées : équipement domestique précoce, réseau de salles de jeu en réseau très dense dès les années 1990, reconnaissance institutionnelle et structures professionnelles créées avant partout ailleurs.`],
    ["L'économie du secteur", `Une structure esport est une organisation professionnelle qui emploie des joueurs, avec entraîneurs, analystes, préparateurs physiques et parfois psychologues — elle fonctionne comme un club sportif. Ses revenus proviennent du sponsoring, des dotations, des droits de diffusion et de la vente de produits dérivés.

Le streaming, diffusion en direct de parties par les joueurs, constitue une source parallèle et souvent supérieure : un joueur peut gagner davantage en diffusant ses entraînements qu'en compétition, ce qui crée une tension entre performance et présence à l'écran. Les carrières restent courtes, la plupart des joueurs professionnels se retirant avant trente ans, en raison des temps de réaction et de la charge d'entraînement quotidienne.`],
    ["La santé", `L'esport pose des enjeux sanitaires spécifiques : sédentarité prolongée, troubles du sommeil liés aux horaires de compétition internationale, pathologies posturales et troubles musculo-squelettiques du poignet et de l'épaule.

Les structures professionnelles ont intégré ces risques en employant des préparateurs physiques et en imposant des routines d'échauffement et de pause — évolution qui rapproche le secteur du sport traditionnel bien plus que les débats sur son statut. La question du temps d'écran des joueurs amateurs, en revanche, relève de la santé publique et non du sport de haut niveau : les deux sujets sont régulièrement confondus.`],
  ],

  "sp3-arbitrage-technologie": [
    ["La vidéo au football", `L'assistance vidéo à l'arbitrage permet de revoir certaines décisions à l'image. Son périmètre est volontairement restreint : buts, penaltys, cartons rouges directs et erreurs d'identité. Elle n'intervient qu'en cas d'erreur claire et manifeste, formule dont l'interprétation nourrit l'essentiel des polémiques.

Elle a été utilisée pour la première fois en Coupe du monde en 2018, en Russie, après des expérimentations en championnats. Deux autres dispositifs l'accompagnent : la goal-line technology, qui détermine automatiquement si le ballon a entièrement franchi la ligne de but et prévient l'arbitre en une seconde ; et le hors-jeu semi-automatisé, qui combine capteurs dans le ballon et suivi optique des joueurs pour réduire à quelques secondes une vérification qui en prenait parfois plusieurs minutes.`],
    ["Les autres sports", `Le challenge, employé au volley-ball comme au tennis ou au cricket, donne à chaque équipe un nombre limité de demandes de vérification vidéo. Le dispositif déplace une part de l'arbitrage vers les compétiteurs eux-mêmes : c'est à eux de décider quand contester, et de gérer leurs recours comme une ressource tactique.

L'escrime a été pionnière bien avant la vidéo : dès le XXe siècle, un capteur électrique signale les touches valables par un signal lumineux, les juges humains étant incapables de départager des actions séparées par quelques millièmes de seconde. L'athlétisme a suivi avec le chronométrage électronique, déclenché automatiquement par le signal de départ, obligatoire pour homologuer un record.`],
    ["Départager l'indépartageable", `La photo-finish n'est pas une photographie instantanée mais un enregistrement en fente : une caméra filme en continu la seule ligne d'arrivée, et l'image obtenue est une bande où l'axe horizontal représente le temps. C'est ce qui permet de départager deux athlètes séparés par un millième de seconde, et d'expliquer les silhouettes déformées de ces images.

Le même principe de mesure directe s'applique en natation avec les plaques de touche, sensibles à la pression, qui arrêtent le chronomètre au contact du nageur. Dans ces disciplines, la technologie n'assiste pas l'arbitre : elle le remplace, parce que l'œil humain est physiquement incapable de la précision requise.`],
    ["Ce qu'elle ne résout pas", `La vidéo réduit certaines erreurs mais allonge les interruptions, et modifie le rapport au jeu : la célébration d'un but est désormais suspendue à une vérification, ce que de nombreux supporters vivent comme une perte.

Surtout, la limite est de nature. La technologie tranche des faits mesurables — le ballon a franchi la ligne, le pied était devant — mais l'interprétation des règles reste humaine : une faute est-elle intentionnelle, un contact est-il suffisant, une charge est-elle imprudente ? Ces questions appellent un jugement que nul capteur ne rend. Le débat s'est donc déplacé, sans se refermer : on ne conteste plus ce qui s'est passé, on conteste ce qu'il fallait en conclure.`],
  ],

  "sp3-records-limites": [
    ["Le ralentissement", `La progression des records ralentit dans la plupart des disciplines mesurables depuis les années 1990. Des travaux de physiologie ont modélisé cette évolution sous forme d'asymptotes : on s'approcherait de limites par paliers de plus en plus petits, sans jamais les atteindre.

Une part des records les plus anciens résiste toutefois pour une raison moins glorieuse : les pratiques de dopage des années 1980, dans un contexte de contrôle bien plus faible, ont produit des performances que des générations propres n'ont jamais approchées. Plusieurs fédérations l'ont reconnu publiquement, sans pouvoir annuler ces marques faute de preuves individuelles.`],
    ["Ce qui fausse la comparaison", `En athlétisme, plusieurs facteurs extérieurs pèsent sur les résultats : le vent, l'altitude et la nature de la piste. Un vent favorable supérieur à deux mètres par seconde invalide un record sur les courses courtes. L'altitude favorise les sprints, la résistance de l'air y étant moindre, et pénalise le fond, l'oxygène disponible étant réduit.

Le matériel a pris un poids croissant, au point de compliquer sérieusement la comparaison entre époques : combinaisons de natation, perches, semelles à plaque de carbone, revêtements de piste. Une performance assistée — obtenue avec un dispositif technique qui améliore le rendement de l'athlète — pose la question de savoir ce que le record mesure exactement, du corps ou de l'équipement.`],
    ["Les cas limites", `Usain Bolt détient depuis 2009 le record du monde du cent mètres en neuf secondes cinquante-huit, marque dont personne ne s'est approché depuis. Sa domination pose la question inverse de celle du plateau : un individu peut décaler brutalement une limite que l'on croyait proche.

Oscar Pistorius, athlète amputé des deux jambes courant avec des prothèses en fibre de carbone, a disputé les Jeux olympiques de Londres en 2012 après une bataille juridique. Le débat scientifique n'a jamais été tranché : les études se contredisent sur l'existence et l'ampleur d'un avantage, faute de pouvoir comparer ce qui n'est pas comparable — une prothèse n'est pas une jambe, en mieux ou en moins bien selon la phase de la course.`],
    ["Les vraies limites", `La génétique du sportif de haut niveau est un ensemble de prédispositions — proportion de fibres musculaires, réponse à l'entraînement, morphologie — insuffisantes sans entraînement. Aucun test génétique existant ne permet de prédire un champion, et les entreprises qui prétendent le contraire vendent une illusion.

Les limites finales sont physiologiques et biomécaniques : capacité maximale de transport d'oxygène, résistance des tendons et des os, contraintes de la thermorégulation. Elles fixent des bornes que les modèles situent, avec des marges d'incertitude importantes. L'histoire du sport invite pourtant à la prudence : chaque limite annoncée impossible à franchir l'a été, et la seule chose qu'on puisse affirmer est qu'il en existe une.`],
  ],

  "sp2-histoire-sport": [
    ["Ce qui fait un sport moderne", `Le sport moderne naît en Grande-Bretagne au XIXe siècle avec la codification écrite des règles. Trois éléments le distinguent des jeux traditionnels : des règles écrites et uniformes, des fédérations qui les édictent et les font respecter, et la mesure des performances — chronomètre, distance, score — qui rend les exploits comparables entre lieux et entre époques.

Les jeux antérieurs ne manquaient ni de codes ni d'enjeu, mais leurs règles étaient locales, orales et variables : on ne jouait pas de la même manière d'un village à l'autre, et rien ne permettait de comparer deux performances. En France, la soule — jeu de ballon collectif et violent opposant des villages entiers — est l'ancêtre commun de plusieurs sports de balle, sans avoir jamais été codifiée.`],
    ["Les public schools", `Les public schools britanniques ont joué le rôle décisif : ces internats d'élite ont codifié et diffusé les règles de nombreux sports, moins par amour du jeu que par souci pédagogique. Le sport y était vu comme un instrument de formation du caractère, de discipline et de canalisation de l'énergie des adolescents.

Chaque établissement ayant ses propres règles, la nécessité de jouer entre écoles a imposé l'écrit et la négociation : c'est ainsi que le football et le rugby se séparent en 1863, sur la question du port du ballon à la main. Les anciens élèves ont ensuite diffusé ces règles dans l'Empire et dans le monde, par le commerce, l'armée et l'ingénierie.`],
    ["L'amateurisme, une barrière sociale", `L'amateurisme du XIXe siècle est un principe qui exclut les sportifs rémunérés. Présenté comme une exigence morale — le sport pour lui-même, sans intérêt vénal — il fonctionnait surtout comme une barrière sociale : seul un homme disposant de revenus pouvait s'entraîner et voyager sans être payé. Certains règlements excluaient explicitement les travailleurs manuels.

Les résistances furent immédiates. Le football anglais autorise officiellement le professionnalisme dès 1885, sous la pression des clubs du nord industriel dont les joueurs étaient ouvriers. Le rugby, lui, se scinde en 1895 sur la même question. Aux Jeux olympiques, l'amateurisme est maintenu bien plus longtemps : le professionnalisme n'y est admis que progressivement à partir des années 1980, la Dream Team de basket en 1992 en marquant l'aboutissement le plus visible.`],
    ["S'organiser, se déplacer, se lire", `La première fédération sportive internationale est créée en 1881 pour la gymnastique, suivie de l'aviron, du patinage et du football. Ces structures rendent possibles les compétitions internationales en garantissant que tout le monde joue selon les mêmes règles.

Deux innovations du XIXe siècle ont porté cette diffusion : le chemin de fer, qui permet à des équipes de se déplacer et à un public de suivre, et la presse, qui publie les résultats, fabrique les réputations et crée un intérêt sans présence physique. Le sport moderne est indissociable de ces deux techniques — sans transport rapide et sans récit imprimé, un championnat national n'a pas de sens. Un dernier héritage mérite mention : le jeu de paume, pratiqué à la cour de France dès le Moyen Âge, est l'ancêtre direct du tennis, dont le vocabulaire français a survécu jusque dans les termes anglais.`],
  ],
};
