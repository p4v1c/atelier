...
Au pénal, la cour d'assises juge les crimes — les infractions les plus graves — avec un jury populaire, tandis que les délits relèvent du tribunal correctionnel. Depuis 2023, les crimes punis de quinze à vingt ans de réclusion — dont la majorité des viols — sont jugés en première instance par la cour criminelle départementale, sans jury populaire. Le procureur de la République représente la société et requiert une peine ; il n'est pas juge. Le juge d'instruction, saisi des affaires les plus complexes, enquête à charge et à décharge : il est le seul magistrat à pouvoir mener une information judiciaire.`],
...
Le taux de change est le prix d'une monnaie exprimé dans une autre. Vingt et un pays utilisent l'euro comme monnaie officielle au sein de la zone euro, la Bulgarie depuis 2026. Enfin, une crise de liquidité bancaire survient lorsqu'une banque solvable ne parvient plus à se financer à court terme : ses actifs valent davantage que ses dettes, mais elle ne peut pas les vendre assez vite — d'où le rôle de prêteur en dernier ressort de la banque centrale.`],
  ],
...
Le traité de Maastricht fixe un plafond de déficit public à trois pour cent du PIB et un plafond d'endettement à soixante pour cent — critères devenus des repères politiques bien au-delà de leur portée juridique effective, et suspendus lors des crises récentes. La dette publique française est détenue par des investisseurs français et étrangers sous forme de titres d'État : elle n'est due ni à un pays ni à une institution unique.`],
    ["Contrôler", `Le premier poste de la dépense publique française n'est ni l'éducation ni la défense : c'est la protection sociale, qui en représente à elle seule plus de quatre dixièmes — et plus de la moitié si l'on y ajoute la santé — lorsqu'on considère l'ensemble des administrations publiques.
...
La DGCCRF contrôle la loyauté des pratiques commerciales et la sécurité des produits. L'action de groupe, introduite en France en 2014 puis refondue par la loi du 30 avril 2025, qui a unifié les régimes sectoriels et ouvert l'action au-delà des seules associations agréées, permet d'engager une action en justice pour un ensemble de consommateurs lésés par un même professionnel, ce qui rend possibles des litiges dont le montant individuel serait trop faible pour justifier un procès. Deux dispositifs récents visent enfin la durabilité : le délit d'obsolescence programmée, qui sanctionne la réduction délibérée de la durée de vie d'un produit, et l'indice de réparabilité, note affichée indiquant la facilité de réparer un appareil.`],
  ],
...
S'y ajoute le chômage conjoncturel, lié à un ralentissement de l'activité, seul à répondre rapidement à une relance. Confondre ces trois chômages conduit à appliquer le mauvais remède, et c'est l'une des sources les plus constantes de désaccord entre économistes et responsables politiques.`],
    ["Les instruments", `Le SMIC est le salaire minimum légal en France, en dessous duquel aucun employeur ne peut rémunérer. Il est revalorisé au moins une fois par an selon une formule tenant compte de l'inflation constatée pour les ménages modestes et de la moitié du gain de pouvoir d'achat du salaire horaire de base ouvrier, avec possibilité de coup de pouce gouvernemental. Cette proportion varie fortement avec l'inflation : elle est montée à un salarié sur six début 2023, au plus fort des revalorisations automatiques, avant de redescendre autour d'un sur huit depuis fin 2024.
...
La politique agricole commune représente encore une part majeure du budget européen, ce qui en fait la politique commune la plus intégrée, et la plus disputée. Elle reste, avec la politique de cohésion, l'un des deux seuls domaines où l'Union dispose de moyens financiers substantiels.`],
...
La durée d'assurance requise est le nombre de trimestres nécessaires pour obtenir le taux plein, qui augmente progressivement selon les générations. Il ne faut pas la confondre avec l'âge légal de départ, qui est l'âge à partir duquel on peut liquider sa retraite : on peut atteindre l'âge légal sans avoir tous ses trimestres, et l'inverse. La loi du 14 avril 2023 porte cet âge légal de soixante-deux à soixante-quatre ans et la durée requise à quarante-trois ans, par paliers selon les générations ; la loi de financement de la Sécurité sociale pour 2026 a toutefois gelé cette montée en charge à partir de septembre 2026, le temps d'un débat sur son financement.
...
La politique agricole commune représente encore environ un tiers de ce budget, part en baisse continue mais qui reste la première, devant la politique de cohésion, qui vise à réduire les écarts de développement entre régions.`],
...
Le G7 est un forum informel réunissant sept grandes économies avancées, sans secrétariat permanent ni pouvoir de décision. Le G20, créé au niveau des chefs d'État en 2008 face à la crise financière, réunit dix-neuf pays, l'Union européenne et, depuis 2023, l'Union africaine, représentant l'essentiel du PIB mondial. Son élargissement traduisait un constat : les décisions économiques mondiales ne pouvaient plus se prendre entre pays occidentaux.
...
L'index de l'égalité professionnelle, obligatoire depuis 2019 pour les entreprises de plus de deux cent cinquante salariés et depuis 2020 pour celles d'au moins cinquante, note sur cent points cinq indicateurs : écart de rémunération, écart de taux d'augmentations, écart de taux de promotions, augmentation au retour de congé maternité, et parité parmi les dix plus hautes rémunérations — les entreprises de moins de deux cent cinquante salariés n'en calculant que quatre, l'écart de taux de promotions étant fondu dans celui des augmentations. Les entreprises sous un seuil de soixante-quinze points doivent corriger sous trois ans sous peine de pénalité.
...
Son mérite est de rendre les écarts publics et comparables ; sa limite est que la moyenne des notes est élevée alors que les écarts persistent — signe que les indicateurs choisis mesurent mal ce qui résiste.`],
  ...
  "ie3-associations-democratie": [
    ["Un tissu considérable", `La France compte environ un million et demi d'associations actives et plus de vingt millions de bénévoles, chiffres qui font du secteur associatif l'une des réalités sociales les plus massives et les moins visibles du pays.
