/** Langue française, premier lot — les cours. */
...
Le calque traduit littéralement une expression étrangère : gratte-ciel décalque skyscraper. L'étymologie populaire, enfin, est un rapprochement erroné qui finit par modifier la forme du mot : choucroute n'a rien à voir avec le chou ni avec la croûte, c'est une déformation de l'alsacien surkrut, et c'est bien la fausse analyse qui a fixé la graphie actuelle.`],
  ...
  "lf-francophonie": [
    ["Une institution née d'Afrique", `L'idée d'une communauté francophone organisée doit beaucoup à des dirigeants africains de la décolonisation, au premier rang desquels Léopold Sédar Senghor, poète et premier président du Sénégal. L'Organisation internationale de la Francophonie réunit aujourd'hui des dizaines d'États et gouvernements ayant le français en partage — certains où il est peu parlé, l'adhésion étant aussi un choix diplomatique.

C'est la République démocratique du Congo qui compte le plus grand nombre de francophones au monde, devant la France. Ce basculement démographique est le fait majeur de la francophonie contemporaine.`],
    ["Le Québec et l'Europe", `Le Québec est la seule province canadienne à avoir le français pour unique langue officielle. La loi 101, adoptée en 1977, en fait la langue de l'administration, du travail, du commerce et de l'affichage, et encadre strictement l'accès à l'école anglophone. C'est l'une des politiques linguistiques les plus volontaristes au monde, et elle a inversé une tendance à l'anglicisation.

En Europe, la Belgique et la Suisse ont leurs particularismes assumés : septante pour soixante-dix, nonante pour quatre-vingt-dix, et huitante dans certains cantons suisses. Ces formes ne sont pas des fautes mais des variantes régionales anciennes, plus régulières que celles retenues par la norme parisienne.`],
    ["Ailleurs, et autrement", `Le Vietnam conserve un usage francophone hérité de la colonisation, aujourd'hui minoritaire mais entretenu par des établissements et des filières universitaires. Deux institutions portent la langue à l'étranger : l'Alliance française, réseau associatif né en 1883, dont chaque implantation est une association de droit local, et TV5 Monde, chaîne internationale diffusant en français depuis 1984.

Il faut enfin distinguer le français des créoles à base lexicale française. Un créole n'est pas un français déformé : c'est une langue née du contact entre le français et d'autres langues, dotée de sa grammaire propre, et devenue langue maternelle de ses locuteurs. Le créole haïtien, langue officielle d'Haïti, compte plus de dix millions de locuteurs.`],
  ],

  "lf-registres-langue": [
    ["Trois registres", `On distingue classiquement trois registres : soutenu, courant, familier. Ils ne disent rien de la correction : une phrase familière peut être parfaitement grammaticale, et une phrase soutenue peut être fautive. Ce qu'ils décrivent, c'est l'adaptation à une situation — qui parle, à qui, dans quel cadre.

Un même locuteur passe d'un registre à l'autre plusieurs fois par jour sans y penser. L'erreur n'est donc pas d'employer le registre familier, mais de l'employer là où la situation en appelle un autre : c'est une question de pertinence, pas de niveau.`],
    ["Les lexiques de groupe", `L'argot est un lexique propre à un groupe social, souvent doté au départ d'une visée cryptique : ne pas être compris des autres. Le verlan en est un procédé particulier, l'inversion des syllabes, dont certains mots ont fini par entrer dans la langue commune — et être reverlanisés une fois éventés.

Le jargon désigne le vocabulaire technique propre à un métier : fonctionnel entre pairs, il devient exclusion quand il s'adresse à des non-initiés. Le régionalisme est un mot ou un tour propre à une aire géographique : chocolatine, poche pour sac, drache pour averse.`],
    ["Ce qui bouge dans le lexique", `Un anglicisme est un emprunt à l'anglais ; un archaïsme, un mot ou un tour sorti de l'usage courant ; un néologisme, un mot nouveau ou un sens nouveau donné à un mot existant. Ces trois catégories décrivent le mouvement permanent du vocabulaire, non des maladies de la langue.
...
Vers 1200 avant notre ère, les Phéniciens mettent au point un alphabet de consonnes d'une simplicité décisive : quelques dizaines de signes au lieu de centaines. Il est l'ancêtre commun du grec, du latin, de l'hébreu et de l'arabe — les Grecs y ajoutant la notation des voyelles. L'alphabet français en compte aujourd'hui vingt-six lettres.`],
    ["Trois autres systèmes", `Toutes les écritures ne notent pas des sons. Un idéogramme note une idée ou un mot plutôt qu'un son : les caractères chinois relèvent de ce principe, ce qui permet à des locuteurs de langues mutuellement incompréhensibles de partager un même écrit.

Le japonais combine ces caractères chinois avec deux systèmes syllabiques propres, les hiragana et les katakana, chaque signe notant une syllabe. Le coréen a suivi une autre voie : le hangeul, créé au XVe siècle sur ordre du roi Sejong, est un alphabet conçu délibérément, dont les formes des consonnes schématisent la position des organes de la parole. Le cyrillique, enfin, dérive principalement du grec, adapté au IXe siècle pour les langues slaves.`],
    ["Écrire autrement, écrire partout", `En 1825, Louis Braille, aveugle depuis l'enfance, met au point un système d'écriture en relief fondé sur une combinaison de six points : il permet non seulement de lire mais aussi d'écrire, ce que les systèmes antérieurs en lettres en relief ne permettaient pas.

À l'ère numérique, le problème est devenu celui de la coexistence : Unicode est une norme attribuant un identifiant unique à chaque caractère de toutes les écritures du monde, y compris les écritures anciennes et les émojis. Sans elle, un texte écrit dans un système ne pourrait pas être affiché ailleurs — ce qui était la situation ordinaire avant les années 1990.`],
  ],

  "lf-grammaire-notions": [
    ["Ce que décrit la grammaire", `La distinction fondatrice est celle de la classe et de la fonction. La classe d'un mot est sa nature — nom, verbe, adjectif, déterminant — et ne change pas selon la phrase. Sa fonction est le rôle qu'il y joue : sujet, complément, attribut. Un même nom peut être sujet dans une phrase et complément dans la suivante : la classe dit ce qu'il est, la fonction ce qu'il fait.

Un déterminant précède le nom et en précise le genre, le nombre ou la référence : articles, possessifs, démonstratifs. Une proposition subordonnée relative, introduite par un pronom relatif, complète un nom en apportant une information sur lui. La voix passive, enfin, est une construction où le sujet subit l'action au lieu de l'accomplir. Un verbe transitif est celui qui se construit avec un complément d'objet.`],
    ["Saussure et la naissance de la linguistique", `Ferdinand de Saussure est considéré comme le fondateur de la linguistique moderne, à partir d'un cours donné à Genève et publié après sa mort par ses étudiants. Il déplace l'objet : il ne s'agit plus de retracer l'histoire des mots, mais de décrire la langue comme un système où chaque élément se définit par ses différences avec les autres.

Il distingue dans le signe deux faces indissociables : le signifiant, image acoustique du mot, et le signifié, le concept auquel il renvoie. Leur lien est arbitraire — rien dans les sons de arbre ne ressemble à un arbre — ce qui explique que les langues découpent le monde différemment.`],
...
Les points de suspension marquent une interruption, une hésitation ou un sous-entendu : ils sont toujours au nombre de trois. Le tiret cadratin, tiret long, sert aux incises — comme ici — et introduit les répliques de dialogue en français, là où l'anglais emploie des guillemets. L'espace insécable, enfin, empêche la coupure entre deux éléments en fin de ligne : elle est indispensable entre un nombre et son unité, ou avant un signe double.`],
    ["Le vocabulaire du typographe", `Une police à empattements porte de petits traits terminaux à l'extrémité des lettres, héritage de la gravure romaine ; les linéales en sont dépourvues. La chasse d'un caractère est la largeur qu'il occupe : dans une police à chasse fixe, dite à espacement constant, toutes les lettres occupent la même largeur, ce qui convient au code informatique et mal au texte courant.

Une ligature fond deux lettres en un seul signe pour éviter une collision disgracieuse, comme dans le groupe f suivi de i. Reste que la typographie ne résout pas tout : dans des jumelles, rien ne distingue à l'écrit l'instrument d'optique des deux sœurs. Seul le contexte lève l'ambiguïté — la langue écrite accepte de vivre avec.`],
  ],

  "lf-lecture-illettrisme": [
    ["Trois mots à ne pas confondre", `L'analphabétisme désigne le fait de n'avoir jamais appris à lire et à écrire. L'illettrisme concerne des personnes qui ont été scolarisées en France mais qui ne maîtrisent plus suffisamment l'écrit pour faire face aux situations courantes : lire une consigne, remplir un formulaire. La distinction est importante, car les réponses pédagogiques diffèrent entièrement.

L'illectronisme, terme plus récent, désigne la difficulté à utiliser les outils numériques courants — ce qui devient un handicap majeur à mesure que les démarches administratives se dématérialisent. En France, environ sept pour cent des adultes sont en situation d'illettrisme, selon les enquêtes de l'INSEE et de l'Agence nationale de lutte contre l'illettrisme, qui coordonne l'action publique en la matière.`],
    ["L'école et l'écrit", `L'alphabétisation de masse est le produit d'un effort scolaire de long terme. La loi Guizot, en 1833, impose une école primaire de garçons par commune. Un demi-siècle plus tard, les lois Ferry de 1881 et 1882 rendent l'école primaire gratuite, laïque et obligatoire, achevant un mouvement engagé bien avant elles — l'alphabétisation progressait déjà fortement au XIXe siècle.

La méthode syllabique de lecture part des lettres et des sons pour construire les syllabes puis les mots. Les recherches en sciences cognitives des vingt dernières années ont largement conforté l'enseignement explicite des correspondances entre graphies et sons, ce qui a orienté les recommandations officielles françaises.`],
    ["Mesurer et rattraper", `L'enquête PISA, conduite par l'OCDE, évalue tous les trois ans les compétences des élèves de quinze ans en compréhension de l'écrit, en mathématiques et en sciences. Ses résultats alimentent les débats nationaux, parfois au-delà de ce que la méthodologie permet de conclure : les comparaisons entre pays sont sensibles aux structures scolaires et aux populations testées.

Pour les adultes, deux dispositifs comptent. La validation des acquis de l'expérience permet de faire reconnaître par un diplôme une expérience professionnelle, sans repasser par la formation initiale. Et la Journée internationale de l'alphabétisation, le 8 septembre, rappelle chaque année que des centaines de millions d'adultes dans le monde ne savent toujours ni lire ni écrire.`],
  ],

  "lf-noms-propres": [
    ["D'où viennent les patronymes", `L'étude des noms propres s'appelle l'onomastique — l'anthroponymie pour les noms de personnes, la toponymie pour les noms de lieux. La plupart des noms de famille français se sont fixés entre le XIe et le XVe siècle, quand la croissance de la population a rendu le seul prénom insuffisant pour identifier quelqu'un.

Quatre origines dominent : un surnom lié à un trait physique ou moral, un métier, un lieu d'origine ou d'habitation, et le prénom du père. Lefebvre, le nom le plus répandu de la seconde catégorie, désigne le forgeron — du latin faber. Le nom de famille le plus porté en France reste Martin, formé sur un prénom lui-même issu du culte de saint Martin de Tours. L'ordonnance de Villers-Cotterêts, en 1539, impose la tenue des registres de baptême, première trace systématique de l'état civil.`],
    ["Les noms de lieux", `Les toponymes conservent des strates linguistiques entières. Le suffixe -ac, dans Cognac, Bergerac ou Aurillac, marque un domaine gallo-romain formé sur le nom de son propriétaire ; il devient -y ou -é dans le nord de la France, ce qui explique des séries comme Vitry ou Savigny.

Le préfixe breton Ker- désigne le village ou le hameau : il ouvre des milliers de noms de lieux en Bretagne occidentale. Certains toponymes remontent plus haut encore : Lyon vient du gaulois Lugdunum, la colline du dieu Lug, avec un élément -dunum qu'on retrouve dans Verdun ou Autun.`],
    ["Les règles d'aujourd'hui", `Le choix du prénom a longtemps été encadré par une loi de l'an XI limitant les prénoms à ceux des calendriers et de l'histoire ancienne. Depuis 1993, les parents sont libres : l'officier d'état civil enregistre le prénom déclaré, et ne peut saisir le procureur que si le prénom paraît contraire à l'intérêt de l'enfant ou au droit des tiers. Le juge tranche alors, et refuse rarement.

La transmission du nom de famille a changé plus récemment encore. Depuis 2005, un enfant peut porter le nom de sa mère, celui de son père, ou les deux dans l'ordre choisi par les parents : la règle du nom paternel automatique, qui n'était d'ailleurs qu'une coutume et non une loi, a pris fin.`],
  ],

  "lf-communication-rhetorique": [
    ["Les trois moyens de persuasion", `Aristote, dans sa Rhétorique, identifie trois moyens de persuasion. L'ethos tient à l'orateur : sa crédibilité, sa probité perçue, l'autorité que lui reconnaît l'auditoire. Le pathos tient aux émotions qu'il suscite. Le logos tient au raisonnement lui-même, aux arguments et à leur enchaînement.

La rhétorique classique distingue de la même façon convaincre, qui s'adresse à la raison, et persuader, qui s'adresse aux émotions. Un discours efficace combine les trois registres ; un discours qui n'en emploie qu'un est presque toujours faible. Le discours classique se découpe lui-même en parties, dont l'exorde, l'ouverture destinée à capter la bienveillance de l'auditoire avant d'exposer quoi que ce soit.`],
    ["Raisonner", `Le syllogisme est la forme canonique du raisonnement déductif : deux prémisses, une conclusion qui en découle nécessairement. Sa validité est formelle — elle dépend de la structure, non du contenu — ce qui explique qu'un syllogisme puisse être valide et pourtant faux, si l'une de ses prémisses l'est.

Un sophisme, à l'inverse, est un raisonnement fallacieux qui a l'apparence de la logique. Il est d'autant plus efficace qu'il ressemble à un argument. Le repérer suppose de distinguer ce qui est affirmé de ce qui est démontré, exercice que la vitesse d'un échange oral rend difficile.`],
    ["Les pièges les plus fréquents", `Quelques sophismes reviennent constamment. L'argument ad hominem attaque la personne plutôt que sa thèse : la biographie de celui qui parle ne prouve ni ne réfute ce qu'il dit. L'homme de paille déforme la position adverse en une version caricaturale, plus facile à démolir que l'originale. L'appel à l'autorité fallacieux invoque un expert hors de son domaine, ou sans que sa parole soit vérifiable. La pétition de principe tient pour acquis ce qu'il s'agit précisément de démontrer.
