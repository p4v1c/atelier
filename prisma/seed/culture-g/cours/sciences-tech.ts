...
Marie Curie est la seule personne à avoir reçu deux prix Nobel dans deux disciplines scientifiques différentes, en physique puis en chimie. Rosalind Franklin, elle, produit les clichés de diffraction aux rayons X qui permettent d'établir la structure en double hélice de l'ADN ; sa contribution fut longtemps minorée, et elle mourut avant l'attribution du Nobel à ses collègues. Sur le plan des décisions publiques, enfin, le principe de précaution inscrit en droit français impose de prendre des mesures proportionnées face à un risque incertain mais grave : il n'ordonne pas l'abstention, il oblige à agir malgré l'incertitude.`],
  ...
  "st2-textile-industrie": [
    ["La première industrie mécanisée", `Le textile a ouvert la révolution industrielle, et pour une raison simple : c'est un travail répétitif, décomposable en gestes élémentaires, réalisé sur une matière légère. Tout y prédisposait la machine.

La séquence des inventions se lit comme une course. La navette volante de John Kay, en 1733, permet à un seul tisserand de lancer la navette d'un bord à l'autre du métier sans aide : le tissage double de vitesse et la filature ne suit plus. La réponse vient en 1764 avec la spinning jenny de James Hargreaves, qui permet de filer plusieurs fils à la fois — jusqu'à huit d'abord, puis des dizaines. Le déséquilibre bascule alors de l'autre côté, et chaque gain d'un atelier appelle un gain dans l'autre. C'est ce mécanisme d'entraînement mutuel, plus qu'une invention isolée, qui fait démarrer l'industrialisation.`],
    ["Des cartes perforées avant l'informatique", `En 1801, Joseph-Marie Jacquard présente un métier utilisant des cartes perforées : chaque carte commande le relevage des fils de chaîne pour une passe de trame, et la succession des cartes définit le motif. Changer de dessin ne demande plus des jours de réglage mais un nouveau paquet de cartes.

L'idée dépasse largement le textile. Charles Babbage s'en inspire pour sa machine analytique, Herman Hollerith l'utilise pour dépouiller le recensement américain de 1890, et les cartes perforées resteront le support d'entrée des ordinateurs jusqu'aux années 1970. Le premier programme de l'histoire a donc été un motif de tissu — filiation que revendiquait Ada Lovelace elle-même, écrivant que la machine analytique tissait des motifs algébriques comme le métier Jacquard tissait des fleurs.

Lyon, capitale de la soie, adopte massivement le procédé : les canuts de la Croix-Rousse en font l'outil de leur métier, et leurs révoltes de 1831 et 1834 comptent parmi les premiers conflits sociaux de l'ère industrielle.`,
      { image: "st-ada-lovelace", legende: "Ada Lovelace : la filiation entre le métier Jacquard et le programme informatique n'est pas une métaphore rétrospective, elle est revendiquée dès 1843.", alt: "Portrait d'Ada Lovelace" }],
    ["De quoi un tissu est-il fait", `Trois familles de fibres coexistent. Les fibres naturelles — coton, lin, laine, soie — sont prélevées telles quelles. Les fibres artificielles sont fabriquées à partir d'une matière naturelle transformée chimiquement : la viscose, obtenue par dissolution puis régénération de la cellulose du bois, en est le type même. Les fibres synthétiques, elles, sont entièrement fabriquées à partir de composés chimiques issus le plus souvent de la pétrochimie — polyester, nylon, élasthanne.

La distinction artificielle/synthétique est constamment confondue dans le langage courant, alors qu'elle est nette : dans un cas la nature fournit la molécule, dans l'autre elle est construite.`],
    ["Trois façons de faire une étoffe", `Le tissage entrecroise deux ensembles de fils perpendiculaires, la chaîne et la trame : il donne une étoffe stable, peu extensible, qui s'effiloche si on la coupe. Le tricotage forme au contraire des mailles à partir d'un seul fil qui se boucle sur lui-même : l'étoffe est élastique, se déforme, et file si une maille lâche — c'est la différence entre une chemise et un tee-shirt. Un tissu non tissé abandonne les deux principes : c'est une nappe de fibres liées mécaniquement ou chimiquement, procédé rapide et bon marché qui donne les lingettes, les masques et les géotextiles.

L'ornement suit sa propre technique. La teinture par réserve protège certaines zones du tissu de la couleur — par nouage, cire ou pinçage — de sorte que le motif naît de ce qui n'a pas été teint. Batik indonésien, shibori japonais, tie and dye reposent tous sur ce principe.`],
    ["Le prix environnemental", `L'industrie textile représente une part importante de la pollution industrielle de l'eau, notamment par la teinture : bains successifs, sels, métaux, fixateurs, avec des rejets souvent peu traités dans les pays où la production s'est concentrée. La couleur des rivières en aval des zones textiles est devenue un indicateur visuel de la mode de la saison.

S'y ajoutent la consommation d'eau du coton, les microfibres synthétiques relâchées à chaque lavage, et surtout l'accélération des cycles : le nombre de collections annuelles a été multiplié, la durée d'usage d'un vêtement divisée. Le problème n'est donc pas seulement technique — les procédés de teinture sans eau existent — mais volumétrique, et il se joue autant dans les habitudes d'achat que dans les usines.`],
  ],

  "st2-construction": [
    ["Faire tenir une charge", `Toute construction résout le même problème : conduire les charges jusqu'au sol sans que rien ne casse en chemin. Deux logiques structurelles s'y opposent. Un mur porteur supporte les charges de la structure sur toute sa longueur : il est massif, contraint les ouvertures et interdit de modifier les cloisons. Une structure poteau-poutre fait passer les charges par des éléments verticaux et horizontaux ponctuels : les murs ne portent plus rien, les façades se libèrent, les plans deviennent modifiables.

Ce basculement, permis par le béton armé et l'acier, est ce qui rend possible l'architecture du XXe siècle — le plan libre et la façade libre de Le Corbusier ne sont pas des idées esthétiques mais les conséquences directes d'un choix structurel.`],
    ["Le béton armé", `Le béton résiste très bien à la compression et très mal à la traction : il s'écrase difficilement, il se fend facilement. L'acier fait l'inverse. Les associer donne un matériau composite où chacun travaille dans son domaine — c'est l'idée du béton armé, dont Joseph Monier dépose un brevet à la fin du XIXe siècle après avoir commencé par des bacs à orangers.

Le béton précontraint pousse le raisonnement plus loin : on comprime le béton par des câbles tendus avant sa mise en charge, de sorte que les efforts de traction ultérieurs viennent seulement annuler cette compression sans jamais mettre le béton en tension. Eugène Freyssinet en fait un procédé industriel dans les années 1930, ce qui permet des portées bien supérieures et des éléments beaucoup plus minces.`],
    ["Sous le bâtiment, et dans le vide", `Une fondation profonde reporte les charges vers des couches résistantes en profondeur, par pieux ou barrettes, lorsque le sol de surface est trop meuble. Sur un sol argileux ou un remblai, c'est elle qui décide de tout : les désordres les plus coûteux d'un bâtiment viennent presque toujours du sol, jamais de la structure elle-même.

Pour franchir, deux familles. Un pont suspendu porte son tablier par des câbles verticaux accrochés à deux grands câbles tendus entre des pylônes : la structure travaille en traction, ce qui autorise les plus grandes portées jamais construites. Une charpente en treillis répartit au contraire les efforts dans un réseau de barres triangulées — le triangle étant la seule figure indéformable sans articuler ses sommets. C'est le principe des ponts métalliques du XIXe siècle et de la tour Eiffel, qui n'est qu'un treillis vertical.`,
      { image: "tour-eiffel", legende: "La tour Eiffel : un treillis de barres triangulées, calculé pour résister au vent avant tout.", alt: "La tour Eiffel vue depuis le Champ-de-Mars" }],
    ["Ce qui a rendu les tours possibles", `Les gratte-ciel apparaissent à la fin du XIXe siècle grâce à la conjonction de deux innovations. L'acier, d'abord, permet une ossature qui porte le bâtiment à la place des murs, dont l'épaisseur en maçonnerie serait devenue prohibitive au-delà d'une dizaine d'étages. L'ascenseur de sécurité d'Elisha Otis, ensuite, présenté en 1854 avec son parachute bloquant la cabine en cas de rupture du câble : sans lui, personne n'aurait loué un dixième étage.

Une ville verticale suppose donc autant une machine qu'une structure — leçon générale de l'histoire des techniques, où les innovations n'ont d'effet qu'assemblées.`],
    ["Le bâtiment qui perd sa chaleur", `L'isolation thermique par l'extérieur consiste à poser l'isolant sur la façade côté extérieur plutôt qu'à l'intérieur. Le gain est double : la surface habitable est préservée, et surtout l'enveloppe isolante devient continue.

Cette continuité est le vrai sujet. Un pont thermique est une zone où l'isolation est interrompue — jonction d'un balcon, d'un plancher, d'un tableau de fenêtre — et où la chaleur s'échappe par le chemin le plus court. Ces zones concentrent une part disproportionnée des déperditions et provoquent des condensations locales, donc des moisissures. Une isolation intérieure très épaisse mais percée de ponts thermiques performe souvent moins bien qu'une isolation extérieure plus modeste mais continue : en thermique du bâtiment, la faiblesse de la chaîne l'emporte sur l'épaisseur du maillon le plus fort.`],
  ],

  "st2-eau-genie-civil": [
    ["Retenir l'eau", `Un barrage doit encaisser une poussée qui croît avec la profondeur et qui atteint des dizaines de milliers de tonnes. Deux stratégies s'affrontent. Le barrage-poids résiste par sa seule masse. Le barrage-voûte est courbe et reporte la poussée de l'eau sur les rives : la coque travaille en compression, ce que le béton fait très bien, et le volume de matériau est bien moindre — à condition d'une gorge étroite et de rives rocheuses saines, faute de quoi la voûte n'a rien où s'appuyer.

Le barrage des Trois-Gorges, en Chine, est le plus grand du monde par sa puissance installée. Il illustre aussi les coûts non financiers de ces ouvrages : plus d'un million de personnes déplacées, sites archéologiques noyés, sédiments retenus en amont et manquant en aval.`],
    ["Franchir les dénivelés", `Une écluse est un sas permettant à un bateau de franchir une différence de niveau : on l'enferme entre deux portes, on remplit ou on vide, on rouvre. Le principe, connu depuis la Chine médiévale et généralisé en Europe à la Renaissance, a rendu navigables des cours d'eau à pente marquée et permis les canaux de partage entre deux bassins, comme le canal du Midi qui franchit le seuil de Naurouze.

Une digue relève d'une autre fonction : ouvrage linéaire protégeant des inondations ou retenant l'eau, elle défend un territoire au lieu de faciliter un passage. Sa faiblesse est structurelle — elle donne un sentiment de sécurité qui encourage à construire derrière, si bien qu'une rupture, toujours possible, produit des dégâts croissants avec le temps.`],
    ["Percer", `Un tunnelier est une machine creusant un tunnel et posant le revêtement en continu : la roue de coupe attaque le front, les déblais sont évacués vers l'arrière, et des anneaux de béton préfabriqué sont mis en place au fur et à mesure derrière le bouclier. Il peut avancer de plusieurs dizaines de mètres par jour sous une ville habitée, sans creusement à ciel ouvert, avec des tassements de surface contrôlés au millimètre.

Deux ouvrages en donnent la mesure. Le tunnel sous la Manche fait environ cinquante kilomètres, dont trente-huit sous la mer, creusés depuis les deux rives et raccordés en 1990 avec un écart de quelques centimètres. Le tunnel de base du Saint-Gothard, plus long tunnel ferroviaire du monde avec cinquante-sept kilomètres, traverse les Alpes à altitude quasi constante pour supprimer la rampe d'accès — sous jusqu'à deux kilomètres de roche, où la température atteint spontanément quarante-cinq degrés.`],
    ["Le vocabulaire des ouvrages", `Un viaduc est un pont franchissant une vallée à grande hauteur, généralement sur plusieurs travées — le viaduc de Millau en est l'exemple le plus célèbre. Un aqueduc conduit l'eau par gravité sur de longues distances, avec une pente d'une régularité extrême : les aqueducs romains descendaient de quelques dizaines de centimètres par kilomètre sur des dizaines de kilomètres, ce qui suppose un nivellement d'une précision remarquable pour des instruments aussi simples.

Le mot générique est ouvrage d'art : dans le vocabulaire du génie civil, une construction ponctuelle — pont, tunnel, mur de soutènement — implantée sur une infrastructure linéaire. L'expression ne désigne pas une prétention esthétique mais un savoir-faire technique, l'« art » y ayant le sens ancien de métier.`],
  ],
};
