...
Le débat portait sur la littérature engagée, que Sartre définissait comme une écriture assumant sa responsabilité politique : l'écrivain est en situation, son silence même est une prise de position. Camus ne contestait pas l'engagement mais la subordination de la morale à l'efficacité historique. Soixante-dix ans plus tard, la question qu'ils s'opposaient n'a rien perdu : au nom de quoi accepte-t-on que des moyens injustes servent une fin juste ?`],
  ...
  "li2-litterature-germanique": [
    ["Goethe, ou soixante ans sur un livre", `Faust a occupé Goethe pendant près de soixante ans : il en écrit les premières scènes vers vingt ans et achève la seconde partie quelques mois avant sa mort, à quatre-vingt-deux ans. Le pacte du savant qui vend son âme contre la connaissance et la jouissance devient, sous sa plume, une somme sur l'ambition humaine — et un texte qu'aucune mise en scène ne joue intégralement.

Bien avant cela, en 1774, Les Souffrances du jeune Werther le rend célèbre dans toute l'Europe à vingt-cinq ans. Le roman épistolaire d'un jeune homme qui se suicide par amour déclenche une vague d'imitations : on s'habille en Werther, on écrit comme lui, et une série de suicides réels lui est attribuée — le premier cas documenté de ce que la sociologie appellera l'effet d'imitation médiatique.`],
    ["Avant le romantisme", `Le Sturm und Drang — tempête et élan — précède le romantisme allemand dans les années 1770 : un mouvement de jeunes auteurs qui revendiquent le génie, la passion et la nature contre les règles héritées du classicisme français. Goethe et Schiller y participent avant de s'en éloigner vers un classicisme allemand.

Le romantisme proprement dit suivra, avec sa fascination pour le Moyen Âge, le fantastique, le conte populaire et la nuit. C'est de ce terreau que sortent les recueils des frères Grimm, entrepris comme un travail philologique et non comme un livre pour enfants. Hoffmann von Fallersleben, philologue et poète, écrit en 1841 le Chant des Allemands, dont la troisième strophe est aujourd'hui l'hymne national.`],
    ["Le roman du déclin", `Thomas Mann publie à vingt-cinq ans Les Buddenbrook, qui suit sur quatre générations le déclin d'une famille de négociants de Lübeck : à mesure que la sensibilité artistique grandit dans la famille, l'aptitude aux affaires s'éteint. Le roman lui vaudra le Nobel.

La Montagne magique, en 1924, se déroule dans un sanatorium suisse où un jeune homme venu pour trois semaines reste sept ans. Le temps s'y dilate, les malades débattent de tout, et l'Europe d'avant 1914 s'y regarde sans se voir. Mann quittera l'Allemagne en 1933 et poursuivra son œuvre en exil, aux États-Unis.`],
    ["Kafka, l'inclassable", `Franz Kafka, né à Prague dans une famille juive de langue allemande, employé d'assurances toute sa vie, écrit la nuit et publie peu. Le Procès met en scène un homme arrêté un matin sans qu'on lui dise jamais de quoi il est accusé, et qui s'épuise dans une procédure sans juge accessible ni acte lisible. La Métamorphose s'ouvre sur un commis voyageur qui se réveille changé en insecte, et sur la réaction de sa famille — d'abord la gêne, puis le rejet.

Kafka demanda à son ami Max Brod de brûler ses manuscrits inédits. Brod refusa et les publia : la quasi-totalité de l'œuvre que nous lisons a donc été sauvée contre la volonté de son auteur. L'adjectif kafkaïen, formé sur son nom, désigne depuis toute situation absurde où l'individu se heurte à une machine impersonnelle.`],
    ["L'exil et la mémoire", `Stefan Zweig, Autrichien, écrivain le plus traduit de son temps, fuit le nazisme et écrit au Brésil Le Monde d'hier, souvenirs d'une Europe cosmopolite anéantie. Il se suicide avec sa femme en 1942, désespérant du retour de cette civilisation.

Après la guerre, Günter Grass publie Le Tambour, où un enfant décide à trois ans de cesser de grandir et traverse le nazisme du regard d'un nain au tambour. Le livre force l'Allemagne à regarder ce qu'elle préférait taire, et vaut à son auteur le Nobel en 1999. Grass révélera lui-même en 2006 son engagement adolescent dans la Waffen-SS, aveu tardif qui a rouvert le débat sur sa position morale de conscience de la nation.`],
  ],

  "li2-litterature-francophone": [
    ["Écrire en français, et pourquoi", `Écrire en français hors de France peut être un choix, un héritage colonial, ou les deux à la fois — et la question travaille les œuvres autant que leurs auteurs. Kateb Yacine disait du français qu'il était un butin de guerre.

Aimé Césaire, Martiniquais, publie en 1939 le Cahier d'un retour au pays natal, long poème où il forge avec Senghor et Damas la notion de négritude : revendiquer une identité noire là où l'assimilation exigeait de l'effacer. La démarche sera plus tard critiquée par ses propres héritiers, qui lui reprocheront de figer une essence.`],
    ["Après la négritude", `Édouard Glissant, Martiniquais lui aussi, propose une autre voie : plutôt qu'une identité racine, une identité relation. Sa notion de Tout-monde décrit un monde où les cultures se transforment au contact les unes des autres sans se dissoudre. Patrick Chamoiseau développe de son côté la créolité, qui revendique la langue et l'imaginaire créoles comme matériau littéraire à part entière.

Frantz Fanon, psychiatre martiniquais engagé dans la révolution algérienne, publie en 1961 Les Damnés de la terre, analyse de la violence coloniale et de ses effets psychiques qui deviendra une référence des mouvements de libération du monde entier.`],
    ["L'Afrique et le Maghreb", `Au Sénégal, Mariama Bâ publie Une si longue lettre, roman épistolaire sur la condition des femmes, la polygamie et le veuvage, qui reste l'un des textes africains les plus lus. Cheikh Hamidou Kane, avec L'Aventure ambiguë, met en scène un jeune Peul partagé entre l'école coranique et l'école française : le roman pose la question du prix à payer pour apprendre à vaincre sans avoir raison.

En Algérie, Kateb Yacine publie Nedjma en 1956, roman à la construction éclatée où quatre hommes tournent autour d'une même femme, figure de l'Algérie. Assia Djebar, romancière et cinéaste, consacre son œuvre à la voix des femmes algériennes et entre à l'Académie française en 2005 — première écrivaine du Maghreb à y siéger.`],
    ["Le Québec et l'Europe", `Gabrielle Roy publie en 1945 Bonheur d'occasion, qui décrit la vie d'un quartier ouvrier de Montréal pendant la guerre : c'est l'un des premiers grands romans urbains québécois, à rebours de la littérature du terroir qui dominait.

Michel Tremblay franchit une autre limite en 1968 avec Les Belles-Sœurs : il fait entrer le joual, parler populaire montréalais, sur la scène d'un théâtre institutionnel. Le scandale fut considérable — on y vit une insulte à la langue — et la pièce est aujourd'hui un classique. En Belgique, une tradition francophone distincte a produit Maeterlinck, prix Nobel en 1911, Simenon et ses centaines de romans, ou encore Amélie Nothomb.`],
  ],
  "li2-autobiographie": [
    ["Tout dire", `Les Confessions de Rousseau, publiées après sa mort, inaugurent l'autobiographie moderne par une prétention inédite : tout dire sur soi, y compris le déshonorant. Il y raconte des vols, des lâchetés, l'abandon de ses cinq enfants aux Enfants-Trouvés. Le pacte qu'il propose au lecteur est celui de la sincérité intégrale, et c'est cette exigence, plus que le récit lui-même, qui fonde le genre.

Le titre est emprunté à saint Augustin, dont les Confessions, treize siècles plus tôt, racontaient une conversion : l'aveu des fautes y servait à magnifier la grâce qui en avait délivré. Le déplacement est considérable — chez Rousseau, l'aveu ne mène plus à Dieu mais à la connaissance de soi.`],
    ["Mémoires de cour et d'outre-tombe", `Le duc de Saint-Simon laisse sur la cour de Louis XIV des mémoires d'une acuité féroce : plusieurs milliers de pages où chaque courtisan est peint en quelques lignes définitives. Il écrit pour l'avenir, sans publier de son vivant, et son texte reste la source la plus vivante sur Versailles — à condition de se rappeler qu'il règle aussi ses comptes.

Chateaubriand pousse le procédé jusqu'au titre : ses Mémoires d'outre-tombe ne devaient paraître qu'après sa mort, ce qui lui permettait de parler des vivants sans conséquence. Écrits sur quarante ans, ils traversent la Révolution, l'Empire, la Restauration, et mêlent l'histoire du siècle à celle d'un homme qui se voit finir avec un monde.`],
    ["Témoigner", `Le Journal d'Anne Frank appartient à une autre catégorie : ce n'est pas une œuvre rétrospective mais un journal tenu au présent par une adolescente cachée à Amsterdam pendant deux ans. Elle le retravaillait elle-même en vue d'une publication, ce qu'on oublie souvent. Elle meurt à Bergen-Belsen à quinze ans ; son père, seul survivant de la famille, publie le texte en 1947.

Primo Levi, chimiste italien déporté à Auschwitz, publie Si c'est un homme en 1947 — refusé par les grands éditeurs, il ne connaîtra le succès qu'une décennie plus tard. Son parti pris est celui de l'analyse froide : décrire le fonctionnement du camp, la dégradation méthodique de l'humain, sans imprécation ni pathos. C'est ce qui en fait l'un des témoignages les plus indiscutables du siècle.`],
    ["Se raconter aujourd'hui", `Sartre publie Les Mots en 1964, récit de son enfance et de son entrée en littérature, où il démonte ironiquement la vocation dont il avait fait sa vie. Il refuse le Nobel la même année.

Annie Ernaux transforme le genre : elle fait de sa vie une enquête sociologique, en écrivant sur son milieu d'origine, son ascension par l'école, l'avortement, la honte sociale, avec une langue plate revendiquée et une distance qui exclut la confidence. Serge Doubrovsky, lui, forge en 1977 le terme d'autofiction pour désigner un récit où l'auteur porte son nom mais assume une part de fiction. Georges Perec, enfin, dans W ou le Souvenir d'enfance, alterne un récit d'enfance lacunaire et une fiction insulaire glaçante : les deux textes ne se rejoignent jamais explicitement, et c'est ce blanc entre eux qui dit l'essentiel — la disparition de ses parents dans la guerre.`],
  ],

  "li2-oulipo-experiences": [
    ["Un atelier, pas un mouvement", `L'Oulipo — Ouvroir de littérature potentielle — est fondé en 1960 par Raymond Queneau et le mathématicien François Le Lionnais. Ce n'est pas un mouvement littéraire mais un atelier de recherche : ses membres inventent et testent des contraintes formelles, qu'ils mettent à disposition de qui veut s'en servir. Le groupe ne publie pas de manifeste et n'exclut personne — on n'en démissionne pas, on n'en est excusé que par décès.

Le principe est contre-intuitif : la contrainte n'appauvrit pas, elle engendre. Obligé de contourner un obstacle, l'auteur trouve des tournures et des images auxquelles il n'aurait jamais pensé. C'est l'inverse exact de l'écriture automatique des surréalistes, qui cherchait à libérer.`],
    ["Perec et l'exploit", `Georges Perec écrit La Disparition, roman de trois cents pages sans une seule lettre e — un lipogramme, c'est-à-dire un texte qui s'interdit une ou plusieurs lettres. La performance n'est pas gratuite : le e absent figure le manque, et le roman parle d'une disparition dont personne ne peut prononcer le nom. Plusieurs premiers lecteurs ne remarquèrent rien.

La Vie mode d'emploi est construite sur le plan d'un immeuble parisien : chaque chapitre visite une pièce, et l'ordre des chapitres suit le parcours d'un cavalier sur un échiquier de cent cases. Des dizaines d'autres contraintes gouvernent la répartition des objets et des thèmes. Le lecteur peut tout ignorer : le livre se lit d'abord comme une accumulation d'histoires.`],
    ["Queneau et les combinaisons", `Cent mille milliards de poèmes est un livre de dix sonnets dont chaque vers est imprimé sur une bande découpée : le lecteur peut combiner librement les vers de même rang, ce qui donne dix puissance quatorze poèmes différents, tous grammaticalement corrects. Queneau calculait qu'il faudrait plusieurs centaines de millions d'années pour tous les lire.

Exercices de style raconte quatre-vingt-dix-neuf fois la même scène — un homme aperçu dans un bus, puis revu deux heures plus tard — dans quatre-vingt-dix-neuf manières différentes : en alexandrins, en argot, au passé simple, sous forme de télégramme, de rêve, d'analyse grammaticale. C'est le meilleur cours de style jamais écrit, et il tient en cent pages. Italo Calvino, membre étranger de l'Oulipo, applique l'esprit du groupe au roman avec Si par une nuit d'hiver un voyageur, livre composé de dix débuts de romans interrompus.`],
    ["Le Nouveau Roman", `Parallèlement, un autre groupe déconstruit le récit. Alain Robbe-Grillet formule son programme dans Pour un nouveau roman : plus d'intrigue, plus de personnage psychologique, plus d'auteur omniscient — l'objet décrit avec une précision maniaque remplace le sens.

Nathalie Sarraute explore une autre direction avec ce qu'elle nomme les tropismes : les mouvements infimes de la conscience, les micro-réactions qui précèdent la parole et que le roman classique ignore. Claude Simon, enfin, reçoit le Nobel en 1985 pour une œuvre où mémoire, guerre et phrases interminables composent un flux sans chapitre. L'Oulipo et le Nouveau Roman partagent une conviction : la forme n'est pas l'habillage du sujet, elle est le sujet.`],
  ],
  "li2-lecture-publique": [
    ["Tout garder", `La Bibliothèque nationale de France conserve, au titre du dépôt légal, un exemplaire de chaque document publié en France : livres, périodiques, partitions, cartes, affiches, disques, et depuis 2006 les sites web français. L'obligation remonte à une ordonnance de François Ier de 1537, ce qui en fait l'un des plus anciens dispositifs de conservation au monde.

Cette exhaustivité a un prix : plusieurs dizaines de kilomètres de rayonnages supplémentaires par décennie, et une politique de conservation qui doit arbitrer entre le papier acide du XIXe siècle, les supports magnétiques illisibles et les formats numériques obsolètes. Le dépôt légal ne garantit pas la lecture, seulement la survie du support.`],
    ["Une longue histoire", `La bibliothèque d'Alexandrie reste la plus célèbre du monde méditerranéen : fondée au IIIe siècle avant notre ère par les Ptolémées, elle visait à rassembler tous les livres du monde connu, avec une méthode brutale — on saisissait les rouleaux des navires en escale pour les copier. Sa destruction ne fut pas un événement unique mais une lente dégradation sur plusieurs siècles.

Les incunables, livres imprimés avant 1501, sont aujourd'hui recensés à environ trente mille éditions dans le monde, pour quelques centaines de milliers d'exemplaires conservés. En France, une bibliothèque municipale classée conserve des fonds patrimoniaux — manuscrits, incunables, fonds anciens — sous contrôle scientifique de l'État, souvent hérités des confiscations révolutionnaires.`],
    ["Qui fait lire", `Le critique littéraire analyse et évalue publiquement des œuvres : son rôle est moins de juger que de trier dans une production que personne ne peut embrasser. En France, la rentrée littéraire concentre à la fin de l'été la publication de plusieurs centaines de romans en quelques semaines — un phénomène sans équivalent ailleurs, qui sature la critique et condamne l'immense majorité des titres à passer inaperçus.

La télévision a joué un rôle décisif : l'émission Apostrophes, animée par Bernard Pivot de 1975 à 1990, faisait vendre des dizaines de milliers d'exemplaires en une soirée. Aucune émission n'a depuis retrouvé ce pouvoir de prescription, désormais fragmenté entre libraires, réseaux sociaux et clubs de lecture — ces derniers, groupes se réunissant pour discuter d'ouvrages lus en commun, ayant connu un regain considérable.`],
    ["Prêter, et libérer", `Le prêt numérique en bibliothèque donne un accès temporaire à un livre numérique, avec des conditions négociées avec les éditeurs : nombre de prêts simultanés, durée, nombre total d'emprunts avant réachat. Le modèle reproduit artificiellement la rareté d'un objet physique, ce qui explique qu'un fichier puisse être indisponible parce qu'il est emprunté.

À l'autre bout, le domaine public rassemble les œuvres dont les droits patrimoniaux ont expiré — en France, soixante-dix ans après la mort de l'auteur. Elles peuvent être librement rééditées, traduites, numérisées et adaptées. C'est ce qui permet à des projets bénévoles de mettre en ligne des dizaines de milliers de textes, et ce qui fait de chaque 1er janvier une date suivie par les bibliothécaires : celle où une nouvelle promotion d'auteurs devient libre.`],
  ],

  "li2-prix-litteraires": [
    ["Le Nobel", `Le prix Nobel de littérature est décerné chaque année à Stockholm par l'Académie suédoise, selon le testament d'Alfred Nobel qui demandait de récompenser une œuvre de tendance idéaliste — formulation vague dont l'interprétation a beaucoup varié. Il distingue une œuvre entière, non un livre.

Le premier lauréat, en 1901, fut le Français Sully Prudhomme, choix aussitôt contesté par des écrivains scandinaves qui estimaient que Tolstoï le méritait davantage. Le palmarès a depuis accumulé les absences remarquables — Tolstoï, Proust, Joyce, Woolf, Borges — ce qui rappelle qu'un prix reflète autant l'état d'un jury que celui de la littérature.`],
    ["Les prix français d'automne", `Le prix Goncourt est décerné par un jury de dix membres réunis chez Drouant, restaurant parisien. Sa dotation est symbolique — dix euros — mais son effet commercial est considérable : il multiplie souvent les ventes par dix ou davantage, et assure au lauréat plusieurs centaines de milliers d'exemplaires.

Autour de lui gravitent des prix nés en réaction. Le Renaudot est décerné le même jour, par des journalistes qui attendaient dans le même restaurant que le Goncourt se décide. Le Femina, créé en 1904 par des collaboratrices d'une revue, est décerné par un jury exclusivement féminin, en réponse au machisme du Goncourt de l'époque. Le Médicis, plus récent, récompense un auteur dont la notoriété ne correspond pas encore au talent — formulation qui en dit long sur les positions que chaque prix cherche à occuper.`],
    ["Ailleurs", `Le Booker Prize récompense un roman de langue anglaise publié au Royaume-Uni ; son ouverture aux auteurs américains en 2014 a fait débat. Le Pulitzer, américain, distingue à la fois le journalisme et la littérature, avec des catégories distinctes — c'est l'un des rares prix à honorer les deux.

Le prix Hugo, en science-fiction, se distingue par son mode d'attribution : il est voté par les lecteurs inscrits à la convention mondiale de science-fiction, et non par un jury d'experts. Cette légitimité populaire lui a valu, dans les années 2010, une tentative organisée de noyautage des votes par des groupes militants — épisode qui a montré la fragilité de tout système de vote ouvert.`],
    ["Ce qu'un prix produit", `Un grand prix littéraire ne récompense pas seulement : il fabrique. Il détermine ce qui sera en pile chez les libraires, traduit à l'étranger, étudié en classe et disponible en poche dans dix ans. Un même livre, primé ou non, ne connaît pas la même postérité.

Cette puissance explique la surveillance dont les jurys font l'objet — conflits d'intérêts entre jurés et maisons d'édition, rotation des maisons couronnées, absence de renouvellement des membres. Plusieurs réformes ont limité les cumuls, sans supprimer le fait central : dans un pays qui publie des centaines de romans par saison, quelques dizaines de personnes décident de ce qui sera lu.`],
  ],
};
