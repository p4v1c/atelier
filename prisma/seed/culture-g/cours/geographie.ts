...
La Nouvelle-Aquitaine est la plus vaste région métropolitaine, plus grande que l'Autriche. Lyon est la préfecture d'Auvergne-Rhône-Alpes, Strasbourg le chef-lieu du Grand Est. Le Nord reste le département le plus peuplé de France, héritage de son industrialisation ancienne.`],
    ["Le relief et l'eau", `La chaîne des Pyrénées s'étire sur environ quatre cent trente kilomètres de l'Atlantique à la Méditerranée — la frontière, qui la suit sans l'épouser, en fait plus de six cents. Sa continuité de crête a longtemps limité les passages — d'où la persistance d'Andorre entre les deux versants. À l'est, le mont Blanc culmine à plus de quatre mille huit cents mètres et constitue le point culminant de la France métropolitaine ; son altitude exacte varie de quelques mètres selon l'enneigement du sommet, mesuré tous les deux ans.
...
Un site mal protégé risque son inscription sur la liste du patrimoine mondial en péril, puis, dans les cas extrêmes, son retrait pur et simple. Cela est arrivé trois fois : au sanctuaire de l'oryx d'Arabie à Oman en 2007, dont le périmètre avait été réduit, à la vallée de l'Elbe à Dresde en 2009, après la construction d'un pont contesté, et au port marchand de Liverpool en 2021.`],
  ],
...
Pour ordonner cette diversité, la classification de Köppen, établie au début du XXe siècle et plusieurs fois révisée, répartit les climats selon les températures et les précipitations : c'est elle qu'on lit derrière les couleurs des cartes climatiques, et ses lettres — A tropical, B aride, C tempéré, D continental, E polaire — servent encore de langue commune.`],
  ],
...
Le statut d'État non reconnu désigne un territoire disposant d'un pouvoir effectif, d'une population et de frontières, mais sans reconnaissance internationale large. Ces entités existent de fait sans exister en droit, ce qui les prive d'accès aux organisations internationales, aux financements et souvent au commerce légal.`],
    ["Les grands contentieux", `Le Cachemire est disputé entre l'Inde, le Pakistan et la Chine depuis 1947 : trois guerres et une ligne de contrôle qui n'est pas une frontière reconnue, dans une zone où deux puissances nucléaires se font face. Le Sahara occidental est administré par le Maroc et revendiqué par un mouvement indépendantiste, dans un conflit longtemps gelé par le cessez-le-feu de 1991, rompu en novembre 2020, et où les affrontements de faible intensité ont repris.
