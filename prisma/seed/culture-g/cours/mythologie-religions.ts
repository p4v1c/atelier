/** Mythologie et religions, premier lot — les cours. */
...
Le mythe central est celui d'Osiris. Roi civilisateur, il est assassiné par son frère Seth, jaloux, qui démembre son corps. Son épouse Isis en rassemble les morceaux et le ranime assez longtemps pour concevoir un fils, Horus. Osiris devient alors souverain du royaume des morts, et Horus, dieu à tête de faucon, venge son père et hérite de la royauté terrestre — chaque pharaon vivant est un Horus, chaque pharaon défunt un Osiris.`],
    ["Peser le cœur", `Le jugement des morts se déroule dans la salle des Deux Vérités. Anubis, dieu à tête de chacal qui préside à l'embaumement, y conduit le défunt et place son cœur sur un plateau de la balance ; sur l'autre repose la plume de Maât, qui figure l'ordre, la justice et la vérité. Si le cœur pèse plus lourd, une créature le dévore et le défunt cesse d'exister. Thot, dieu à tête d'ibis et scribe des dieux, enregistre le verdict.

Le Livre des morts n'est pas un récit mais un recueil de formules destinées à guider le défunt dans l'au-delà et à lui faire franchir les épreuves. Déposé dans la tombe, souvent sur un rouleau de papyrus, il était en partie personnalisé.`],
    ["Trois mille ans, et une exception", `L'Égypte a maintenu ses cultes pendant plus de trois millénaires, ce qui constitue un record dans l'histoire des religions. Cette continuité connaît une rupture spectaculaire au XIVe siècle avant notre ère : le pharaon Akhenaton impose un culte quasi exclusif au disque solaire Aton, ferme les temples des autres dieux et fonde une nouvelle capitale. La réforme ne survit pas à sa mort, et ses successeurs effacent jusqu'à son nom.

Parmi les symboles les plus répandus, le scarabée occupe une place à part. L'insecte roulant sa boule devant lui évoquait le soleil poussé à travers le ciel : il figure le renouvellement et la renaissance, et se retrouve en amulettes par milliers, souvent placées sur le cœur des momies.`],
  ],

  "mr-judaisme": [
    ["Les textes", `La Torah désigne les cinq premiers livres de la Bible hébraïque — Genèse, Exode, Lévitique, Nombres, Deutéronome. Elle est lue publiquement à la synagogue selon un cycle annuel, sur un rouleau manuscrit.

Le Talmud, achevé vers le VIe siècle, est d'une nature très différente : ce n'est pas un code mais l'enregistrement d'un débat. Il rassemble la Mishna, compilation de traditions orales, et la Guemara, discussion qui la commente. Sa singularité est de conserver les opinions minoritaires et les désaccords non tranchés, ce qui en fait un texte à lire plus qu'un texte à appliquer. Une page de Talmud imprimée dispose d'ailleurs le texte central entouré de commentaires écrits des siècles plus tard.`],
    ["Le temps et les fêtes", `Le shabbat, du vendredi soir au samedi soir, est le repère hebdomadaire : jour de repos où toute activité créatrice est suspendue.

Trois fêtes majeures rythment l'année. Pessah commémore la sortie d'Égypte, avec le repas du seder et l'interdiction du pain levé pendant une semaine. Yom Kippour, le jour du Grand Pardon, est marqué par un jeûne de vingt-cinq heures et une journée entière de prière ; c'est le jour le plus solennel du calendrier. Hanouka, moins centrale mais très visible, commémore la rededicace du Temple de Jérusalem au IIe siècle avant notre ère, par l'allumage progressif d'un chandelier à neuf branches — huit bougies, une de plus chaque soir, plus la servante qui les allume.`],
    ["Pratiques et courants", `La cacherout est l'ensemble des règles alimentaires : espèces autorisées, abattage rituel, séparation stricte du lait et de la viande. La synagogue n'est pas un temple mais un lieu de prière, d'étude et de rassemblement communautaire — la distinction compte, le Temple de Jérusalem détruit en 70 n'ayant jamais été reconstruit. La bar-mitsva marque le passage d'un garçon à la majorité religieuse, à treize ans, avec la lecture publique d'un passage de la Torah ; la bat-mitsva en est l'équivalent féminin, plus récent.

Parmi les courants, le hassidisme naît en Europe orientale au XVIIIe siècle : mouvement mystique et populaire, il met l'accent sur la ferveur et la joie plutôt que sur la seule érudition, autour de figures de maîtres charismatiques.`],
  ],

  "mr-christianisme": [
    ["D'une secte juive à une religion d'empire", `Le christianisme naît au sein du judaïsme du Ier siècle, autour de la personne de Jésus de Nazareth. Quatre Évangiles sont reconnus canoniques — Matthieu, Marc, Luc et Jean — parmi une production bien plus abondante que l'Église a écartée.

Longtemps minoritaire et périodiquement persécuté, le christianisme change de statut en 313, quand l'empereur Constantin l'autorise par l'édit de Milan. Il devient religion officielle de l'Empire à la fin du siècle. En 325, le concile de Nicée formule un credo commun pour trancher les disputes sur la nature du Christ : c'est le premier concile œcuménique, et le modèle de tous les suivants.`],
    ["Deux ruptures", `Les trois grandes branches du christianisme viennent de deux ruptures. La première, en 1054, sépare Rome et Constantinople : c'est le Grand Schisme d'Orient, qui distingue catholiques et orthodoxes sur des questions de doctrine, de liturgie et surtout d'autorité — les orthodoxes refusant la primauté du pape.

La seconde est la Réforme du XVIe siècle. En 1517, Martin Luther affiche quatre-vingt-quinze thèses contre le commerce des indulgences ; le mouvement échappe vite à son intention initiale de réformer de l'intérieur. Jean Calvin s'installe à Genève et y organise une Église réformée dotée d'une discipline stricte. En Angleterre, l'anglicanisme naît d'une cause différente : la rupture d'Henri VIII avec Rome en 1534, motivée d'abord par une affaire de divorce.`],
    ["Répondre et se réformer", `L'Église catholique répond à la Réforme par le concile de Trente, réuni par intermittence de 1545 à 1563 : il précise la doctrine, réforme la discipline du clergé, crée les séminaires et engage ce qu'on appelle la Contre-Réforme.

Quatre siècles plus tard, le concile Vatican II, tenu de 1962 à 1965, marque une autre inflexion : liturgie célébrée en langue vernaculaire et prêtre tourné vers les fidèles, ouverture au dialogue avec les autres confessions et religions, nouvelle formulation des rapports de l'Église au monde moderne. À la tête de l'Église catholique, le pape est d'abord l'évêque de Rome : sa primauté se fonde sur la succession de l'apôtre Pierre.`],
  ],

  "mr-islam": [
    ["Les fondements", `L'islam sunnite compte cinq piliers : la profession de foi, la prière cinq fois par jour, l'aumône légale, le jeûne du mois de ramadan et le pèlerinage à La Mecque, appelé hajj, pour qui en a les moyens. La fête de l'Aïd el-Fitr commémore la fin du ramadan.

Le Coran est divisé en cent quatorze chapitres, les sourates, rangées non par ordre chronologique mais approximativement par longueur décroissante. Les hadiths, distincts du Coran, rapportent les paroles et les actes attribués au Prophète ; leur authenticité a fait l'objet d'une science de la critique des chaînes de transmission. Le calendrier musulman commence avec l'hégire, le départ de La Mecque vers Médine en 622, événement politique autant que religieux.`],
    ["Sunnites, chiites, soufis", `La division entre sunnites et chiites naît d'une question de succession, non d'un désaccord doctrinal initial : à la mort du Prophète, fallait-il choisir un successeur parmi ses compagnons, ou la direction revenait-elle à sa famille, en la personne d'Ali ? Les positions se sont ensuite chargées de doctrine, de droit et de rituels distincts, mais l'origine est politique. Les sunnites représentent aujourd'hui environ neuf musulmans sur dix.

Le soufisme n'est pas une branche mais une voie mystique, présente dans les deux ensembles : recherche d'une expérience intérieure de Dieu, transmission par des maîtres, confréries, pratiques de récitation. Il a joué un rôle majeur dans la diffusion de l'islam en Afrique et en Asie.`],
...
Politiquement, la dynastie abbasside établit Bagdad comme capitale au VIIIe siècle et y organise un âge d'or intellectuel : traductions du grec, du persan et du sanskrit, mathématiques, médecine, astronomie. C'est dans cet ensemble que travaillent al-Khwarizmi, dont le nom a donné algorithme, et plus tard Avicenne.`],
  ...
  "mr-religions-monde": [
    ["Trois traditions indiennes et japonaises", `Le sikhisme naît au XVe siècle au Pendjab, en Inde, autour de Nanak : monothéiste, il refuse les castes et le rituel sacrificiel, et rassemble ses enseignements dans un livre saint traité comme un maître vivant. Le turban et le sabre portés par les hommes initiés sont des signes d'appartenance, non des ornements.

Le jaïnisme, plus ancien, place au centre l'ahimsa, la non-violence envers tout être vivant, poussée à un degré rarement atteint : les moines balaient leur chemin pour ne pas écraser d'insecte. Au Japon, le shintoïsme vénère les kami, esprits présents dans les lieux, les phénomènes naturels et les ancêtres ; il coexiste avec le bouddhisme sans exclusivité, la plupart des Japonais recourant aux deux selon les circonstances.`],
    ["Doctrines et dualismes", `Le confucianisme n'est pas d'abord une religion mais une doctrine morale et politique : elle fixe des rôles, une éthique des relations et un idéal de l'homme cultivé, sans culte d'un dieu ni promesse d'au-delà. Sa portée sur les sociétés d'Asie orientale a pourtant été comparable à celle d'une religion.

Le taoïsme place au centre le tao, la voie naturelle qu'il s'agit de suivre sans forcer — d'où le principe du non-agir, qui n'est pas passivité mais refus de l'effort contre-productif. Le zoroastrisme, fondé en Perse et attesté dès le premier millénaire avant notre ère, oppose un principe bon à un principe mauvais dans un affrontement dont dépend le monde : ce dualisme a marqué durablement les représentations du bien et du mal.`],
    ["Croyances diffuses et non-croyance", `L'animisme désigne la croyance en une force ou un esprit animant les êtres, les objets et les éléments. Le terme a été forgé par des anthropologues du XIXe siècle et recouvre des réalités très diverses, ce qui invite à s'en servir avec prudence. Le vaudou rassemble des cultes ouest-africains et leurs prolongements américains, nés de la traite : Haïti, le Brésil et Cuba en portent des formes distinctes, souvent mêlées de catholicisme.

En France, la laïcité est un principe de neutralité de l'État, garantissant la liberté de conscience et l'égalité des citoyens quelle que soit leur croyance : elle n'impose rien aux individus, elle oblige la puissance publique. Enfin, les personnes sans affiliation religieuse représentent environ un quart de la population mondiale, en forte hausse depuis 2010, ce qui en ferait le troisième ensemble après le christianisme et l'islam — sans qu'il s'agisse d'un groupe homogène.`],
  ],

  "mr-symboles-rites": [
    ["Ce que font les rites", `L'ethnologue français Arnold Van Gennep a montré en 1909 que les rituels marquant un changement de statut social suivent partout la même structure en trois temps : séparation, où l'individu quitte son état antérieur ; marge, phase liminaire d'entre-deux, souvent d'épreuve ; agrégation, où il rejoint la société avec son nouveau statut. Baptême, service militaire, mariage, remise de diplôme relèvent du même schéma.

Émile Durkheim, de son côté, définit le sacré non par une propriété intrinsèque, mais par la séparation : est sacré ce que la société elle-même met à part du profane. Le sacré n'est donc pas la marque d'une réalité supérieure, mais un fait social.`],
    ["Interdits, emblèmes, échanges", `Un tabou est une interdiction dont la transgression est perçue comme dangereuse en elle-même, indépendamment de toute sanction extérieure. Le mot vient du polynésien, importé en Europe par les récits de voyage du XVIIIe siècle.

Un totem est un être ou un objet servant d'emblème à un groupe, souvent assorti d'interdits et d'une parenté symbolique. Marcel Mauss, enfin, a analysé le don et le contre-don : offrir crée une obligation de rendre, et cet enchaînement d'obligations lie durablement les groupes. Le don apparemment gratuit est donc, dans de nombreuses sociétés, un mécanisme d'alliance et de hiérarchie.`],
    ["Symboles et circulations", `Le yin et le yang figurent deux principes complémentaires, chacun contenant un point de l'autre : la représentation dit précisément qu'aucun des deux n'existe à l'état pur et que leur alternance fait le mouvement du monde.

Le pèlerinage est un voyage vers un lieu tenu pour sacré ; il combine effort physique, rupture avec le quotidien et rencontre collective. Une relique est un reste corporel ou un objet lié à un personnage sacré, dont la possession a fait au Moyen Âge la richesse et le prestige de nombreuses églises. Le syncrétisme religieux, enfin, désigne la fusion d'éléments issus de traditions différentes : loin d'être une exception, c'est un mode de fonctionnement ordinaire des religions au contact les unes des autres.`],
  ],

  "mr-mythes-fondateurs": [
    ["Des motifs qui voyagent", `Le récit du déluge n'est pas propre à la Bible : on en trouve une version dans l'Épopée de Gilgamesh, texte mésopotamien antérieur de plus de mille ans, avec un héros averti, une arche, des animaux embarqués et un oiseau lâché pour trouver la terre. La parenté est trop précise pour être fortuite : elle indique une circulation de récits dans le Proche-Orient ancien.

D'autres motifs reviennent d'une culture à l'autre : le héros civilisateur qui donne aux hommes ce que les dieux leur refusaient, la faute originelle qui introduit le mal, la confusion des langues comme punition d'une démesure — c'est ce que raconte la tour de Babel, qui explique par un mythe l'origine de la diversité linguistique.`],
    ["Les Grecs", `Prométhée dérobe le feu aux dieux pour le donner aux hommes, et Zeus le condamne à voir son foie dévoré chaque jour : le mythe dit à la fois la grandeur du progrès technique et son prix. En réponse, les dieux envoient Pandore, qui ouvre la jarre libérant tous les maux sur le monde — seule l'espérance reste au fond, image dont le sens est encore discuté.

Les héros donnent d'autres leçons. Héraclès accomplit douze travaux imposés en expiation. Thésée affronte le Minotaure au cœur du labyrinthe et ne retrouve la sortie que grâce au fil d'Ariane. Icare, dont le père a fabriqué des ailes de plumes et de cire, vole trop près du soleil et tombe : la démesure est punie. Sisyphe, condamné à rouler éternellement un rocher qui retombe, est devenu l'image de l'effort absurde.`],
    ["Fonder un peuple", `La légende du roi Arthur, roi breton entouré de chevaliers en quête du Graal, n'a que peu de fondement historique : elle se construit du XIIe au XVe siècle et fournit à plusieurs royaumes un passé prestigieux. C'est exactement la fonction d'un mythe fondateur : un récit qui explique l'origine d'un peuple, d'une dynastie ou d'une institution, et qui la légitime.

Rome avec Romulus et Remus, la France avec ses origines troyennes imaginées au Moyen Âge, bien des nations modernes avec leurs récits d'émancipation : le mythe fondateur ne se juge pas à son exactitude, mais à ce qu'il permet de tenir ensemble. Le repérer n'oblige pas à le mépriser ; cela oblige à ne pas le confondre avec de l'histoire.`],
  ],

  "mr-philosophie-religion": [
    ["Les positions", `L'agnosticisme n'est pas une position intermédiaire entre la foi et l'athéisme : il ne porte pas sur ce qu'on croit mais sur ce qu'on peut savoir, et affirme qu'on ne peut établir si Dieu existe. On peut donc être agnostique et croyant, ou agnostique et athée.

Le déisme est la croyance en un Dieu créateur, connaissable par la raison, mais sans religion révélée, sans miracles ni Écritures : c'est la position de nombreux philosophes des Lumières, dont Voltaire. Le panthéisme, associé à Spinoza, identifie Dieu et la nature : Dieu n'est pas un être distinct qui aurait créé le monde, il est ce monde même, saisi comme totalité.`],
    ["Arguments et objections", `L'argument ontologique, formulé par Anselme de Cantorbéry au XIe siècle, veut déduire l'existence de Dieu de son seul concept : si Dieu est ce dont on ne peut rien concevoir de plus grand, il doit exister, car exister est plus grand que ne pas exister. L'argument a été réfuté par Kant, qui objecte que l'existence n'est pas une propriété comme les autres.

Le pari de Pascal déplace la question : au lieu de démontrer, il calcule. Si Dieu existe, croire fait gagner une félicité infinie ; s'il n'existe pas, la perte est finie. Il serait donc rationnel de parier sur son existence. L'objection classique tient à ce qu'on ne choisit pas de croire, et que le pari ne dit pas en quel dieu parier. Face à ces constructions, le problème du mal reste l'objection la plus tenace : comment concilier l'existence du mal avec un Dieu à la fois bon, tout-puissant et omniscient.`],
    ["Le retrait du religieux", `Nietzsche déclare que Dieu est mort — formule qui n'est pas un cri de victoire mais un constat inquiet : ce qui fondait les valeurs a cessé d'être crédible, et il reste à savoir ce qui pourra le remplacer. Marx, lui, écrit que la religion est l'opium du peuple, expression souvent citée à moitié : elle est pour lui à la fois consolation réelle d'une détresse réelle et illusion qui en détourne.

La sécularisation désigne le recul de l'emprise du religieux sur les institutions, les normes et les mœurs. Le processus est net en Europe occidentale, mais ne se vérifie pas partout, ce qui a conduit les sociologues à nuancer les théories des années 1960. À l'opposé de la démonstration rationnelle, le fidéisme soutient que la foi ne peut être fondée par la raison et qu'elle relève d'un autre ordre.`],
  ],

  "mr-calendriers-fetes": [
    ["Lune, soleil, ou les deux", `Un calendrier purement lunaire compte douze mois lunaires, soit environ trois cent cinquante-quatre jours : il dérive d'environ onze jours par an par rapport à l'année solaire. C'est pourquoi les fêtes musulmanes, dont le ramadan, se décalent chaque année et parcourent toutes les saisons en une trentaine d'années.

Le calendrier juif évite cette dérive en étant luni-solaire : il ajoute un mois intercalaire selon un cycle de dix-neuf ans, ce qui maintient les fêtes dans leur saison. Le calendrier chinois fonctionne sur un principe comparable : le nouvel an chinois célèbre le début de l'année luni-solaire, ce qui explique qu'il tombe entre fin janvier et mi-février.`],
    ["Les dates mobiles et la réforme", `La date de Pâques chrétienne suit une règle fixée au concile de Nicée : le premier dimanche après la pleine lune qui suit l'équinoxe de printemps. Elle peut donc varier de plus d'un mois, et entraîne avec elle toutes les fêtes qui en dépendent.

En 1582, le pape Grégoire XIII réforme le calendrier julien, qui avait accumulé dix jours de retard sur le soleil : dix jours furent supprimés d'un coup et la règle des années bissextiles affinée. Les pays protestants et orthodoxes ont adopté ce calendrier grégorien bien plus tard, parfois au XXe siècle. Plusieurs Églises orthodoxes continuent de suivre le calendrier julien pour leurs fêtes, d'où un Noël célébré le 7 janvier.`],
    ["Fêtes et héritages", `Halloween vient d'une fête celtique de fin des récoltes et d'ouverture de la saison sombre, reprise par la veille de la Toussaint chrétienne, puis rediffusée mondialement par la culture nord-américaine. Diwali, la fête des lumières, est célébrée notamment dans l'hindouisme et marque la victoire de la lumière sur l'obscurité par des milliers de lampes allumées. Nowrouz, le Nouvel An perse, commémore l'équinoxe de printemps et se célèbre bien au-delà de l'Iran, dans toute l'Asie centrale.

Reste une énigme quotidienne : pourquoi sept jours ? L'héritage est babylonien, lié aux sept astres visibles à l'œil nu et tenus pour errants — Soleil, Lune, Mars, Mercure, Jupiter, Vénus, Saturne. Leurs noms se lisent encore dans ceux de nos jours.`],
  ],
...
Bénarès, ou Varanasi, au bord du Gange, est l'un des principaux lieux de pèlerinage hindou : y mourir et y être incinéré est réputé libérer du cycle des renaissances. Les rives, aménagées en escaliers appelés ghats, accueillent ablutions, prières et crémations sans séparation entre le quotidien et le sacré.`],
    ["Marcher, et le reste du monde", `Saint-Jacques-de-Compostelle, en Galice, est l'aboutissement d'un réseau de chemins parcourus depuis le Moyen Âge et remis en usage à la fin du XXe siècle. Une part importante de ceux qui les empruntent aujourd'hui n'ont pas de motivation religieuse explicite, ce qui n'ôte rien au caractère rituel de la marche. Lourdes, dans les Pyrénées, attire de son côté plusieurs millions de visiteurs chaque année depuis les apparitions mariales de 1858 : c'est le premier lieu de pèlerinage français.

Ailleurs, Borobudur, à Java, est le plus grand temple bouddhiste du monde : un immense mandala de pierre du IXe siècle que le pèlerin gravit en spirale. Angkor Vat, au Cambodge, fut d'abord un temple hindou dédié à Vishnou avant de devenir bouddhiste. La mosquée de Kairouan, en Tunisie, est la plus ancienne encore en fonction du monde musulman occidental. Et le mont Athos, en Grèce, abrite une république monastique orthodoxe autonome, interdite aux femmes depuis mille ans.
...
Sa diffusion en Occident a suivi deux voies. D'abord les traductions savantes du XIXe siècle, qui en ont donné une image philosophique et désincarnée, largement construite par les orientalistes européens. Puis, à partir des années 1960, les diasporas asiatiques et les mouvements de contre-culture, qui en ont fait une pratique vécue. La méditation sécularisée constitue une troisième voie, où la technique est retenue et le cadre religieux écarté — évolution que certains maîtres saluent et que d'autres jugent appauvrissante.`],
  ...
  "mr2-religions-france": [
    ["Une loi, et ses exceptions", `La loi de 1905 de séparation des Églises et de l'État ne s'applique pas de la même façon sur tout le territoire français. Son article 2 pose que la République ne reconnaît, ne salarie ni ne subventionne aucun culte — mais l'Alsace et la Moselle, alors allemandes en 1905, relèvent toujours du régime concordataire hérité de Napoléon : les ministres de quatre cultes y sont rémunérés par l'État et l'enseignement religieux figure au programme scolaire.

D'autres exceptions existent en outre-mer, avec des régimes variés selon les territoires. La laïcité française n'est donc pas un principe uniforme mais une construction historique, avec ses strates et ses compromis.`],
    ["Qui possède les églises", `Une conséquence peu connue de 1905 : les édifices cultuels construits avant cette date appartiennent aux communes pour les églises paroissiales, et à l'État pour les cathédrales. Ils sont mis gratuitement à disposition des cultes, et leur entretien incombe au propriétaire public.

Ce dispositif explique que des communes financent la réfection de toitures d'églises sans contrevenir à la loi, et qu'un édifice construit après 1905 — comme la plupart des mosquées et des temples récents — ne bénéficie d'aucun soutien équivalent. C'est l'une des inégalités de fait les plus discutées du droit des cultes français. Les cultes s'organisent depuis en associations cultuelles, dont l'objet doit être exclusivement l'exercice d'un culte.`],
    ["La neutralité, et ses destinataires", `Le principe de neutralité s'applique aux agents publics : dans l'exercice de leurs fonctions, ils ne doivent manifester aucune conviction religieuse — ni signe, ni prosélytisme. Il ne s'applique pas aux usagers du service public, qui restent libres de leurs convictions et de leur expression, sauf exceptions prévues par la loi.

La loi de 2004 constitue précisément l'une de ces exceptions : elle interdit les signes religieux ostensibles aux élèves des écoles, collèges et lycées publics. Elle ne concerne ni les universités, ni les accompagnateurs, ni la rue. La confusion entre neutralité des agents et liberté des usagers est la source de la majorité des malentendus sur la laïcité française.`],
    ["Un paysage religieux", `Le catholicisme est historiquement majoritaire en France, même si les enquêtes montrent une baisse continue de l'affiliation déclarée et une pratique régulière devenue minoritaire. Le protestantisme réformé est notamment implanté dans les Cévennes, où les huguenots ont résisté après la révocation de l'édit de Nantes — le Désert cévenol désigne cette période de culte clandestin.

Les Juifs obtiennent la pleine citoyenneté en 1791, pendant la Révolution : la France est le premier pays d'Europe à leur accorder l'émancipation civile. L'islam est aujourd'hui la deuxième religion du pays par le nombre de fidèles. Pour éclairer l'application du principe, l'Observatoire de la laïcité, créé en 2007 et remplacé en 2021 par un comité interministériel, a produit analyses et recommandations à destination des administrations et des collectivités.`],
  ],

  "mr2-ethique-religions": [
    ["Pas de position unique", `Les positions religieuses ne sont pas homogènes : chaque tradition connaît des courants divergents, et parler de la position de l'islam ou du christianisme sur une question de société relève presque toujours de la simplification. Les débats internes y sont souvent plus vifs que les oppositions entre traditions.

La bioéthique — réflexion sur les questions morales soulevées par les sciences du vivant — en offre l'illustration la plus nette : procréation médicalement assistée, recherche sur l'embryon, fin de vie, modification génétique. Chaque tradition y mobilise ses textes, sa théologie et sa casuistique, et aboutit à des positions qui varient selon les écoles et les pays.`],
    ["Ce que l'Église catholique a écrit", `Deux encycliques marquent la doctrine sociale catholique. Rerum novarum, publiée en 1891 par Léon XIII, en constitue l'acte fondateur : elle reconnaît la question ouvrière, condamne à la fois le libéralisme sans frein et le socialisme collectiviste, et affirme le droit d'association des travailleurs.

Laudato si', publiée en 2015 par François, porte sur l'écologie : elle articule crise environnementale et justice sociale sous le terme d'écologie intégrale, et a eu un retentissement dépassant largement le monde catholique — elle a été citée dans les négociations climatiques de la même année.`],
    ["Les questions qui divisent", `La fin de vie divise les traditions religieuses comme les sociétés : l'admissibilité de l'euthanasie et du suicide assisté fait l'objet de positions officielles majoritairement défavorables, avec des nuances importantes sur l'arrêt des traitements et la sédation. Sur le don d'organes, à l'inverse, les grandes traditions convergent : il est généralement encouragé comme acte de solidarité, plusieurs autorités religieuses ayant dû le rappeler face à des réticences culturelles.

La place des femmes dans les fonctions religieuses traverse aujourd'hui plusieurs traditions : ordination, direction de communautés, enseignement, transmission. Les évolutions y sont très inégales — certaines Églises protestantes ordonnent des femmes depuis des décennies, d'autres traditions n'envisagent pas la question.`],
    ["Se parler, et les limites", `Le dialogue interreligieux désigne des échanges organisés entre représentants de traditions différentes. Il a été profondément transformé pour l'Église catholique par le concile Vatican II, qui reconnaît des éléments de vérité dans les autres traditions religieuses — rupture avec une position antérieure d'exclusivité.

Deux notions bornent ce paysage. Le fondamentalisme désigne une lecture littérale des textes érigée en norme exclusive, présente dans toutes les traditions et pas seulement dans certaines. La dérive sectaire, au sens du droit français, ne se définit pas par les croyances — qui sont libres — mais par les actes : atteinte aux libertés, à la santé ou aux biens par une pression psychologique organisée. La distinction est essentielle : c'est le comportement qui est sanctionnable, jamais la doctrine.`],
  ],
  "mr2-art-sacre": [
    ["Bâtir selon le ciel", `L'orientation des églises vers l'est n'est pas un hasard architectural mais un choix symbolique : le chœur est tourné vers le soleil levant, image de la résurrection, et c'est de là que vient le verbe orienter. Cette règle, très largement suivie du haut Moyen Âge au XVIIIe siècle, cède devant les contraintes de terrain dans les villes denses.

Les autres traditions ont leurs propres orientations. Une mosquée est bâtie de sorte que le mur de qibla soit dirigé vers La Mecque, ce que signale une niche ; le minaret, tour depuis laquelle est lancé l'appel à la prière, en constitue le repère extérieur. Une synagogue est orientée vers Jérusalem et contient obligatoirement une arche abritant les rouleaux de la Torah.`],
    ["Les images, et leur refus", `L'icône, dans la tradition orthodoxe, n'est pas un tableau religieux : c'est une image sacrée peinte selon des règles précises — modèles transmis, couleurs codifiées, absence de perspective, inscription du nom. Elle est tenue pour une fenêtre vers le divin plutôt que pour une représentation. L'iconostase, cloison couverte d'icônes, sépare le sanctuaire de la nef dans les églises orientales, et matérialise ce seuil.

À l'inverse, l'islam sunnite écarte largement la représentation figurée dans le cadre religieux, ce qui a fait de la calligraphie arabe un art majeur : le texte coranique devient lui-même motif ornemental, sur les murs, les céramiques et les manuscrits. Le judaïsme connaît une réserve comparable, avec des variations selon les époques et les lieux.`],
    ["Chanter", `Un chant liturgique est intégré au déroulement d'un office : il ne l'accompagne pas, il en fait partie. Cette fonction explique des contraintes propres — intelligibilité du texte, adaptation au rite, participation possible de l'assemblée — qui ont façonné toute la musique occidentale ancienne.

Deux formes ont ensuite quitté l'église pour la salle de concert. Le requiem est une messe pour les défunts, dont le texte latin a été mis en musique par des dizaines de compositeurs, parfois pour des concerts plutôt que pour des funérailles. L'oratorio est une œuvre vocale religieuse sans mise en scène ni décor, née à Rome au XVIIe siècle comme substitut à l'opéra pendant le carême.`],
    ["Les objets de la dévotion ordinaire", `Un ex-voto est un objet offert en remerciement d'un vœu exaucé : plaque gravée, tableau naïf, maquette de bateau, béquille abandonnée. Il relève d'une dévotion populaire, distincte de la liturgie officielle, et constitue une source historique précieuse — les ex-voto marins racontent les naufrages, ceux des sanctuaires les épidémies et les guérisons.

Ces pratiques rappellent que la vie religieuse ne se réduit ni aux textes ni aux édifices majeurs. Reliques, médailles, pèlerinages, processions et objets de piété constituent une religion vécue, souvent mal vue des autorités théologiques, et pourtant plus répandue que la fréquentation régulière des offices.`],
  ],

  "mr2-superstitions": [
    ["Des origines oubliées", `Beaucoup de superstitions ont une origine pratique ou religieuse oubliée, ce qui les rend d'autant plus tenaces : on suit la règle sans savoir pourquoi, donc sans pouvoir la discuter.

La crainte du chiffre treize à table renvoie au souvenir de la Cène et de ses treize convives, dont l'un devait trahir. Le miroir brisé porte malheur en raison d'une croyance antique selon laquelle le reflet contenait une part de l'âme — sept ans de malheur correspondant au temps supposé de renouvellement du corps. Toucher du bois pour conjurer le sort remonte probablement à d'anciennes croyances liées aux esprits des arbres, avec une réinterprétation chrétienne ultérieure autour du bois de la Croix.`],
    ["Chance et malchance", `Le trèfle à quatre feuilles symbolise la chance en raison de sa rareté : la mutation qui le produit concerne environ un trèfle sur dix mille, ce qui suffit à faire du hasard de sa découverte un présage.

Le chat noir est associé au malheur en Europe à cause de son assimilation médiévale à la sorcellerie, dans un contexte où les procès de sorcellerie ont conduit à des massacres de chats. Ailleurs — au Japon, en Écosse —, il est au contraire de bon augure, ce qui suffit à démontrer que ces significations n'ont rien de naturel. Un porte-bonheur est un objet censé attirer la chance ou écarter le malheur, catégorie qui traverse toutes les cultures et résiste parfaitement à la sécularisation.`],
    ["Le cas de l'astrologie", `L'astrologie est une pratique attribuant une influence aux astres sur les destinées humaines. Elle a partagé pendant des siècles ses observations avec l'astronomie, dont elle ne se distinguait pas : Kepler établissait des horoscopes. La séparation s'est faite avec la méthode expérimentale — l'astronomie est une science, avec des prédictions vérifiables et falsifiables ; l'astrologie est une croyance, dont les prédictions ne résistent pas aux tests contrôlés.

Sa persistance s'explique en partie par un mécanisme psychologique documenté : l'effet Barnum, ou effet de validation subjective, désigne la tendance à reconnaître comme personnellement exacte une description suffisamment vague pour s'appliquer à presque tout le monde. Les expériences le montrent facilement : distribuez le même portrait à cent personnes en le présentant comme personnalisé, la plupart s'y reconnaîtront.`],
    ["Des croyances rentables", `De nombreux immeubles américains n'ont pas de treizième étage : la numérotation saute directement du douzième au quatorzième. La raison n'est pas la croyance des promoteurs mais celle supposée des acheteurs — c'est une superstition commerciale, entretenue parce qu'elle coûte moins cher qu'un étage invendable.

Le même calcul s'observe ailleurs : absence de rangée treize dans certains avions, de chambre treize dans des hôtels, d'étage quatre en Asie de l'Est où le mot se prononce comme celui de la mort. Ces aménagements montrent qu'une superstition n'a pas besoin d'être crue pour produire des effets matériels durables : il suffit qu'on suppose que d'autres y croient.`],
  ],

  "mr2-athées-libres-penseurs": [
    ["Une position longtemps impossible", `L'athéisme explicite est resté longtemps impensable ou dangereux à exprimer publiquement. Jusqu'au XVIIIe siècle, nier Dieu exposait au bûcher, à la prison ou à l'exil, et les rares textes que nous en avons circulaient sous le manteau ou de façon posthume.

La libre pensée désigne le courant qui revendique l'autonomie de la raison face aux dogmes : elle ne se confond pas nécessairement avec l'athéisme, puisqu'elle porte d'abord sur la méthode — examiner par soi-même — plutôt que sur la conclusion. En France, elle s'organise au XIXe siècle et joue un rôle actif dans le combat pour la laïcité.`],
    ["Les antécédents antiques", `Épicure fonde au IVe siècle avant notre ère une école matérialiste : le monde est fait d'atomes et de vide, l'âme est matérielle et se dissout à la mort, les dieux existent peut-être mais ne s'occupent pas des hommes. Sa conclusion morale est apaisante et non désespérée : puisque la mort n'est rien pour nous, il n'y a pas lieu de la craindre.

Le poète latin Lucrèce expose cette philosophie en vers dans De la nature des choses, texte perdu puis retrouvé au XVe siècle, dont la redécouverte a nourri toute la pensée moderne. Sa description du monde sans providence, faite d'atomes qui dévient, a impressionné jusqu'aux physiciens contemporains.`],
    ["Les modernes", `Spinoza est exclu de la communauté juive d'Amsterdam en 1656, à vingt-trois ans, pour des motifs que le texte de l'exclusion ne précise pas. Il développera ensuite une pensée qui identifie Dieu et la nature, souvent qualifiée de panthéiste, et qui ôte à Dieu la personnalité, la volonté et la providence. Il publie l'essentiel de son œuvre de façon posthume ou anonyme.

Jean Meslier, curé de campagne mort en 1729, laisse un testament qui est le premier texte athée systématique de la littérature française : il y confesse n'avoir jamais cru et dénonce la religion comme un instrument de domination. Le manuscrit circule clandestinement et Voltaire en publie une version expurgée. Un siècle plus tard, Ludwig Feuerbach propose une explication de la religion comme projection : ce que l'homme attribue à Dieu, ce sont ses propres qualités portées à l'absolu — thèse dont Marx puis Freud reprendront le principe.`],
    ["Aujourd'hui", `Athéisme et agnosticisme ne s'opposent pas sur le même plan : le premier porte sur la croyance — je ne crois pas —, le second sur la connaissance — on ne peut pas savoir. On peut donc être agnostique et athée, position la plus courante en pratique.

Le scepticisme scientifique désigne une démarche exigeant des preuves proportionnées aux affirmations, applicable à toute assertion et non aux seules questions religieuses. En droit, la liberté de conscience garantit aux non-croyants le droit de ne pas croire et de ne subir aucune contrainte religieuse — symétrique de la liberté de culte. Les enquêtes menées en Europe occidentale depuis 1970 montrent une hausse continue des personnes sans affiliation religieuse, avec une accélération marquée chez les générations les plus récentes.`],
  ],

  "mr2-mythes-modernes": [
    ["Une structure qui revient", `Les récits de super-héros reprennent des structures narratives très anciennes. Joseph Campbell, mythologue américain, a décrit sous le nom de monomythe une trame commune à de nombreuses cultures : un héros ordinaire reçoit un appel, franchit un seuil, affronte des épreuves avec l'aide d'un mentor, meurt symboliquement, et revient transformé avec un bienfait pour sa communauté.

Sa thèse a été critiquée par les spécialistes, qui lui reprochent de gommer les différences entre traditions pour faire tenir un schéma unique. Elle a en revanche connu un immense succès pratique : George Lucas l'a explicitement utilisée pour construire La Guerre des étoiles, et des générations de scénaristes s'en servent depuis comme d'un outil — au risque d'une standardisation que Campbell n'avait pas prévue.`],
    ["Les récits qui circulent", `Une légende urbaine est un récit contemporain présenté comme vrai, circulant de bouche à oreille puis en ligne, généralement attribué à l'ami d'un ami. Elle possède les caractéristiques du conte — variantes, adaptation locale, morale implicite — tout en se donnant pour un fait divers.

Le complotisme relève d'un autre registre : une explication systématique des événements par un dessein caché, où le hasard et l'incompétence n'ont aucune place. Sa structure est proche de celle du mythe — un récit total qui explique tout et résiste à la réfutation, puisque toute preuve contraire devient la preuve du complot. Les récits d'apocalypse, très présents dans la culture contemporaine, remplissent une fonction comparable : ils disent une fin du monde et surtout ce qui vient après, c'est-à-dire ce qui, dans notre société, mériterait de survivre.`],
    ["Les mythes qui fondent", `Les nations modernes se donnent presque toutes un mythe de fondation légitimant leur existence : un ancêtre commun, une résistance héroïque, un moment originel. Ces récits ne sont pas nécessairement faux, mais ils sélectionnent, simplifient et ordonnent — ce qui est précisément la fonction d'un mythe.

Le héros culturel, figure présente dans d'innombrables traditions, apporte à l'humanité un savoir ou un bien fondateur : le feu, l'écriture, l'agriculture, les lois. Prométhée en est la version grecque, mais on le retrouve du Pacifique à l'Amazonie. Sa persistance dans les récits contemporains — l'inventeur génial, le fondateur visionnaire — indique que la fonction n'a pas disparu avec les dieux.`],
    ["Le sacré ailleurs", `La sacralisation d'objets profanes désigne l'attribution d'une valeur quasi sacrée à des objets ordinaires : reliques sportives, maillots, guitares, manuscrits, lieux de mémoire. Les comportements qui l'accompagnent — pèlerinage, interdit de toucher, émotion à la vue — sont ceux du sacré religieux, sans le cadre.

De même, un rite civil contemporain est une cérémonie non religieuse marquant une étape de vie : mariage civil, parrainage républicain, cérémonie de remise de diplôme, funérailles laïques. Les sciences sociales étudient ces phénomènes non par curiosité mais parce qu'ils révèlent, comme les mythes anciens, les valeurs et les angoisses d'une société — ce qu'elle tient pour intouchable et ce qu'elle craint.`],
  ],

  "mr2-eschatologie": [
    ["Le discours sur la fin", `L'eschatologie est le discours sur les fins dernières : mort individuelle, destin de l'âme, fin du monde, jugement. Chaque tradition en propose une version, et les représentations de l'au-delà varient profondément d'une tradition à l'autre — au point qu'il n'existe aucun modèle commun.

L'évolution interne à une même tradition est parfois plus grande qu'entre traditions. Dans la Bible hébraïque ancienne, le shéol est un séjour indistinct des morts, sombre et sans rétribution marquée : bons et méchants y descendent également. L'idée d'une justice après la mort n'apparaît que tardivement, et transforme entièrement le sens de la vie terrestre.`],
    ["Juger, peser, purifier", `La pesée de l'âme égyptienne est l'une des plus anciennes représentations d'un jugement des morts : le cœur du défunt est placé sur une balance face à la plume de Maât, figure de la justice et de l'ordre. Un cœur trop lourd est dévoré, et le défunt cesse d'exister — la peine n'est pas la souffrance éternelle mais l'anéantissement.

Dans les traditions abrahamiques, la résurrection des morts désigne le retour à la vie corporelle lors du jugement final : ce n'est pas l'immortalité d'une âme séparée mais le rétablissement de la personne entière. Le jugement dernier a fourni à l'iconographie chrétienne l'un de ses sujets majeurs, sculpté aux tympans des cathédrales. Le purgatoire, doctrine catholique précisée au Moyen Âge, désigne un état de purification avant l'accès au ciel — notion absente des Églises orthodoxes et rejetée par la Réforme.`],
    ["Recommencer, ou festoyer", `Le samsara des traditions indiennes propose un modèle entièrement différent : ni jugement unique ni éternité, mais un cycle de morts et de renaissances déterminé par les actes. La libération consiste alors à sortir du cycle, non à obtenir une place favorable — inversion complète du problème.

Le Valhalla nordique, demeure où les guerriers morts au combat festoient en attendant la bataille finale, n'est pas non plus une récompense au sens moral : c'est une sélection guerrière, sans rapport avec la vertu. Ces exemples rappellent que l'au-delà n'est pas nécessairement un tribunal.`],
    ["Ce que font les vivants", `Le culte des ancêtres regroupe les pratiques rituelles qui maintiennent un lien avec les défunts de la lignée : offrandes, autels domestiques, fêtes annuelles. Très répandu en Asie de l'Est et en Afrique, il structure la parenté autant que la religion, et a longtemps résisté aux missions chrétiennes qui y voyaient de l'idolâtrie.

Pour les archéologues, les pratiques funéraires constituent la source la plus riche : la disposition des corps, le mobilier déposé, la localisation et la taille des tombes livrent des indices sur l'organisation sociale, les hiérarchies, les échanges et les croyances d'une société. Une grande part de ce que nous savons des sociétés sans écriture vient de leurs tombes.`],
  ],
  "mr2-pelerinages": [
    ["Marcher pour changer", `Le pèlerinage combine presque toujours un déplacement physique et une transformation intérieure attendue : ce n'est pas un voyage vers un lieu, c'est un déplacement de soi que le lieu autorise. Cette structure explique la persistance de la pratique dans des sociétés largement sécularisées.

Le hajj de La Mecque rassemble chaque année environ deux millions de personnes en quelques jours, ce qui en fait l'un des plus grands rassemblements humains réguliers au monde et un défi logistique considérable. En Inde, la Kumbh Mela dépasse ces chiffres d'un ordre de grandeur : elle rassemble des dizaines de millions de personnes venues se baigner au confluent de fleuves sacrés, et constitue probablement le plus grand rassemblement humain de la planète.`],
    ["Les chemins de Saint-Jacques", `Les chemins de Saint-Jacques traversent la France vers l'Espagne depuis le Moyen Âge, avec quatre grandes voies historiques convergeant vers les Pyrénées. Ils ont structuré des réseaux d'hospitalité, de commerce et d'échange d'informations à l'échelle du continent.

La coquille Saint-Jacques était à l'origine la preuve rapportée d'être parvenu jusqu'à l'océan, au-delà du tombeau : elle est devenue l'emblème du chemin et du pèlerin. Aujourd'hui, la Compostela est le certificat délivré à celui qui arrive à Saint-Jacques, sur présentation d'une créanciale tamponnée aux étapes — dispositif administratif hérité du Moyen Âge et toujours en vigueur.`],
    ["Ailleurs", `Le judaïsme antique prescrivait trois pèlerinages annuels à Jérusalem, à l'occasion de trois fêtes : la montée au Temple structurait le calendrier et l'économie de la région. La destruction du Temple en 70 y a mis fin, transformant durablement la pratique religieuse juive.

Au Japon, le pèlerinage de Shikoku fait le tour d'une île en visitant quatre-vingt-huit temples, sur plus de mille kilomètres. En Bretagne, le pardon est un pèlerinage local avec procession en l'honneur d'un saint, souvent assorti d'une fête : la dimension communautaire y prime sur la distance parcourue.`],
    ["Fonctions anciennes, motifs nouveaux", `Historiquement, les pèlerinages ont rempli des fonctions qui dépassaient largement la dévotion : ils créaient des réseaux d'hospitalité, faisaient circuler des marchandises, des nouvelles et des techniques, et constituaient l'une des rares occasions de voyager légitimement pour un paysan médiéval.

Leur regain contemporain combine des motivations hétérogènes : spirituelles pour une part, mais aussi sportives, touristiques et personnelles — rupture professionnelle, deuil, transition de vie. Les enquêtes menées sur les chemins de Saint-Jacques montrent qu'une majorité des marcheurs ne se déclarent pas croyants pratiquants, ce qui n'enlève rien à la dimension rituelle de leur démarche.`],
  ],

  "mr2-conciles-doctrines": [
    ["Fixer ce qu'il faut croire", `La plupart des grands schismes chrétiens sont nés de débats sur la nature du Christ — question qui paraît abstraite et qui engageait en réalité tout l'édifice : si le Christ n'est pas Dieu, l'incarnation et la rédemption changent de sens.

Le concile de Nicée, en 325, tranche contre l'arianisme, qui soutenait que le Fils est une créature, engendrée et donc inférieure au Père. Le concile affirme au contraire qu'il est de même substance. Cent vingt-six ans plus tard, le concile de Chalcédoine précise l'articulation : le Christ a deux natures, divine et humaine, unies sans confusion en une seule personne. Plusieurs Églises orientales ont refusé cette formulation et se sont séparées à cette occasion — elles existent toujours.`],
    ["Les querelles qui séparent", `La querelle du Filioque porte sur un seul mot ajouté au Credo en Occident : l'Esprit saint procède du Père et du Fils, ou du Père seul ? Le désaccord, doctrinal et surtout politique — Rome ayant modifié unilatéralement un texte conciliaire —, compte parmi les causes du schisme de 1054 entre catholiques et orthodoxes.

La querelle des indulgences, cinq siècles plus tard, porte sur la remise des peines temporelles en échange de dons. La pratique, dévoyée en collecte de fonds pour la basilique Saint-Pierre, déclenche la protestation de Luther en 1517 et, de proche en proche, la Réforme.`],
    ["La grâce, question explosive", `La doctrine de la prédestination, chez Calvin, soutient que Dieu a décidé de toute éternité du salut de chacun, indépendamment de ses mérites. La position est cohérente avec l'affirmation de la toute-puissance divine et redoutable pour ses conséquences psychologiques — elle a nourri, selon Max Weber, une éthique du travail où la réussite devenait un signe d'élection.

Le jansénisme est un courant catholique rigoriste sur la même question de la grâce, condamné au XVIIe siècle après un conflit qui a occupé la France entière : Port-Royal, Pascal, les Provinciales, la destruction de l'abbaye sur ordre du roi. Ce qui se jouait derrière la théologie était aussi une lutte de pouvoir entre le roi, les jésuites et une élite parlementaire.`],
    ["Les conciles récents", `Le premier concile du Vatican proclame en 1870 le dogme de l'infaillibilité pontificale : le pape ne peut errer lorsqu'il définit solennellement une doctrine de foi ou de morale. Le champ en est étroitement délimité — il n'a été invoqué explicitement qu'une fois depuis — mais sa proclamation a provoqué des ruptures et de vives réactions politiques.

Vatican II, réuni de 1962 à 1965, opère plusieurs changements majeurs, dont l'autorisation de la liturgie en langue vernaculaire : la messe cesse d'être obligatoirement dite en latin — le latin reste autorisé, c'est son caractère exclusif qui prend fin — et le prêtre se tourne vers l'assemblée. Le concile ouvre aussi l'Église à l'œcuménisme, recherche de l'unité entre confessions chrétiennes, et au dialogue avec les autres religions. Ces décisions restent contestées par des courants traditionalistes, qui ont entraîné des schismes durables.`],
  ],

  "mr2-religions-chiffres": [
    ["Compter, et ses pièges", `Compter les fidèles d'une religion suppose des conventions discutables : appartenance déclarée, pratique effective, ou simple héritage culturel ? Selon le critère retenu, les chiffres d'un même pays varient du simple au triple.

S'y ajoutent des différences de méthode : certains États recensent la religion, d'autres l'interdisent — c'est le cas de la France, où seules des enquêtes par sondage existent. Certaines institutions comptent les baptisés, d'autres les pratiquants. Ces écarts expliquent que les chiffres publiés diffèrent sensiblement selon les sources, et invitent à lire toute statistique religieuse avec sa définition.`],
    ["La répartition mondiale", `Le christianisme est la religion la plus répandue dans le monde, avec environ un tiers de la population, devant l'islam, autour d'un quart. Mais la géographie a basculé : la majorité des chrétiens du monde vit aujourd'hui hors d'Europe, principalement en Afrique subsaharienne et en Amérique latine — inversion complète par rapport au début du XXe siècle.

C'est en Indonésie que vit la plus grande population musulmane du monde, et non au Proche-Orient. L'hindouisme est la religion majoritaire en Inde, où il compte plus d'un milliard de fidèles. Et le pays comptant la plus forte proportion de personnes sans religion est la Chine, pour des raisons à la fois historiques, politiques et liées à des traditions qui ne se pensent pas comme des religions au sens occidental.`],
    ["Les dynamiques", `L'islam connaît la croissance démographique la plus rapide, pour une raison principalement démographique et non de conversion : ses populations sont plus jeunes et leur fécondité plus élevée. Les projections à l'horizon 2050 le situent au niveau du christianisme, avec les incertitudes propres à tout modèle démographique de long terme.

En Europe occidentale, la sécularisation se traduit par un recul de la pratique et de l'affiliation institutionnelles, plus rapide chez les jeunes générations. Ce mouvement n'est pas universel : il ne s'observe ni en Afrique, ni dans une grande partie de l'Asie, ni aux États-Unis au même rythme — ce qui a conduit les sociologues à abandonner l'idée d'une sécularisation inéluctable liée au développement.`],
    ["Le droit et la contrainte", `La liberté religieuse, au sens des textes internationaux, comprend le droit de croire, de pratiquer, de changer de religion et de n'en avoir aucune. Ce dernier point — le droit d'apostasie — est celui qui reste le moins garanti dans le monde, plusieurs États le sanctionnant pénalement.
...
La qibla est la direction de La Mecque vers laquelle on prie : elle est indiquée dans les mosquées par une niche, et sa détermination a occupé les astronomes et les mathématiciens musulmans, qui ont développé pour cela des méthodes de géométrie sphérique très en avance sur leur temps. La zakat, aumône obligatoire calculée sur le patrimoine et non sur le revenu, complète ces obligations : c'est un prélèvement annuel à taux fixe, redistribué à des catégories définies.`],
    ["Le temps du jeûne", `Le ramadan est un mois de jeûne de l'aube au coucher du soleil : ni nourriture, ni boisson, ni tabac entre l'aube et le crépuscule. Le calendrier étant lunaire, il se décale d'environ onze jours par an et parcourt toutes les saisons — un ramadan d'été aux latitudes nordiques impose des jeûnes de dix-huit heures, ce qui a donné lieu à des avis juridiques spécifiques.
...
Son appropriation par le nazisme l'a rendue inutilisable en Occident et pénalement sanctionnée dans plusieurs pays. C'est l'illustration la plus brutale du principe posé au début : l'interprétation d'un symbole religieux exige toujours de savoir qui l'emploie, où, quand et dans quelle intention. Le même dessin peut orner un seuil de maison en Inde et constituer un délit en Allemagne.`],
  ...
  "mr3-religion-politique": [
    ["Toute la gamme", `Les rapports entre religion et État varient de la fusion complète à la séparation stricte. À un extrême, la théocratie fonde l'autorité politique sur une autorité religieuse : les gouvernants tiennent leur légitimité de Dieu, et le droit religieux est le droit de l'État. À l'autre, la séparation stricte interdit toute reconnaissance publique d'un culte.

Entre les deux, l'État confessionnel reconnaît une religion officielle sans être gouverné par elle : le Royaume-Uni, le Danemark ou la Grèce en relèvent, avec des Églises établies et une liberté religieuse garantie. Le césaropapisme désigne une configuration inverse de la théocratie : c'est le pouvoir politique qui contrôle l'institution religieuse, comme dans l'Empire byzantin ou la Russie impériale.`],
    ["Les théories médiévales", `La doctrine des deux glaives, formulée au Moyen Âge, distingue le pouvoir spirituel et le pouvoir temporel : Dieu aurait confié deux épées, l'une à l'Église, l'autre au prince. Toute la question, qui a occupé cinq siècles de conflits, était de savoir si le second tenait la sienne directement de Dieu ou par l'intermédiaire du premier.

La querelle des Investitures, aux XIe et XIIe siècles, a porté sur un cas concret : qui nomme les évêques, le pape ou l'empereur ? L'enjeu était considérable, les évêques détenant des terres et des pouvoirs seigneuriaux. Le compromis trouvé a durablement séparé la fonction spirituelle de la fonction temporelle.`],
    ["Les positions françaises", `Le gallicanisme est une doctrine limitant l'autorité du pape sur l'Église de France, au profit du roi et des évêques français : elle a été soutenue par la monarchie et par une partie du clergé pendant plusieurs siècles. L'ultramontanisme lui répond en affirmant l'autorité pleine du pape — le terme signifie littéralement au-delà des monts, c'est-à-dire du côté de Rome.

Cette opposition a structuré le catholicisme français jusqu'au XIXe siècle, où l'ultramontanisme l'emporte, notamment avec la proclamation de l'infaillibilité pontificale en 1870. La séparation des Églises et de l'État, en 1905, met fin à un régime concordataire d'un siècle : l'État ne reconnaît, ne salarie ni ne subventionne aucun culte.`],
    ["Ailleurs, et une distinction", `Un concordat est un accord entre un État et le Saint-Siège organisant les rapports avec l'Église catholique : nomination des évêques, statut du clergé, enseignement. La France en a connu un de 1801 à 1905, et il subsiste en Alsace-Moselle.

Les États-Unis ont choisi une autre formule dès l'origine : le premier amendement interdit au Congrès d'établir une religion et de gêner son libre exercice. La séparation y protège d'abord les Églises de l'État, alors qu'en France elle a protégé l'État des Églises — inversion qui explique bien des malentendus. Une dernière distinction mérite d'être posée : la liberté de conscience est plus large que la liberté de culte, car elle protège aussi ceux qui ne pratiquent aucun culte et ceux qui changent de religion.`],
  ],

  "mr3-religions-afrique": [
    ["Une pluralité, pas une religion", `Parler de la religion traditionnelle africaine au singulier n'a pas de sens : il s'agit d'un ensemble de traditions locales très diverses, majoritairement orales, propres à des peuples et à des régions. Elles partagent quelques traits — importance des ancêtres, présence d'un être suprême souvent lointain, rôle de spécialistes rituels — sans former un système commun.

Le culte des ancêtres y occupe une place centrale : il maintient un lien entre vivants et défunts de la lignée, par des offrandes, des libations et des consultations. Les ancêtres ne sont pas des dieux mais des membres de la famille qui ont changé d'état, et qui restent parties prenantes des affaires du groupe. Un féticheur est un spécialiste rituel manipulant des objets chargés de puissance — le terme, forgé par les Portugais, porte une connotation péjorative que l'anthropologie a largement abandonnée.`],
    ["Ce que la traite a transporté", `Le vodun, au Bénin, est une religion structurée, dotée d'un panthéon, d'un clergé et de rites d'initiation ; elle est officiellement reconnue et dispose d'une fête nationale. Transportée aux Amériques par la traite, elle a donné naissance à des religions nouvelles.

Le candomblé brésilien est héritier des traditions yoruba, avec ses divinités, ses transes rituelles et ses maisons de culte. La santeria cubaine mêle ces mêmes traditions au catholicisme : chaque divinité y a été associée à un saint, procédé qui a permis de pratiquer sous couvert de dévotion catholique. Ces religions ont longtemps été réprimées et sont aujourd'hui reconnues, sans que la stigmatisation ait disparu.`],
    ["Le christianisme africain", `L'Afrique subsaharienne est aujourd'hui l'un des principaux foyers de croissance du christianisme, particulièrement dans ses formes évangéliques et pentecôtistes. Cette croissance est démographique autant que missionnaire, et elle a déplacé le centre de gravité du christianisme mondial.

Les Églises indépendantes africaines constituent un phénomène distinct : fondées par des Africains hors des missions occidentales, souvent à la suite d'une rupture avec elles, elles articulent christianisme et pratiques locales — guérison, prophétie, rapport aux esprits. Elles étaient déjà nombreuses au début du XXe siècle et ont préparé le terrain aux formes pentecôtistes actuelles.`],
    ["L'islam et les confréries", `L'islam est présent en Afrique depuis le VIIIe siècle, diffusé par le commerce transsaharien et par les routes de la mer Rouge bien avant toute conquête. En Afrique de l'Ouest, il s'organise largement en confréries soufies, structures religieuses qui encadrent aussi la vie sociale et économique : la confrérie mouride au Sénégal contrôle des activités agricoles et commerciales considérables.

Ces situations illustrent une caractéristique générale : traditions locales et religions monothéistes coexistent souvent par articulation et emprunts plutôt que par exclusion. Un même individu peut fréquenter la mosquée ou l'église et consulter par ailleurs un spécialiste traditionnel, sans y voir de contradiction — logique de complémentarité des recours plutôt que d'appartenance exclusive.`],
  ],
  "mr3-religions-ameriques": [
    ["Ce que l'évangélisation a produit", `L'évangélisation des Amériques a produit des formes religieuses inédites. Le syncrétisme y désigne la combinaison de traditions autochtones ou africaines et du catholicisme : les divinités anciennes se sont maintenues sous des noms de saints, les lieux de culte se sont superposés, les calendriers se sont ajustés.

La Vierge de Guadalupe en est l'exemple le plus considérable : une apparition mariale rapportée en 1531 à un indigène, sur une colline où était vénérée une divinité mexica, avec une image au teint sombre. Elle est devenue le symbole national mexicain, portée aussi bien par les insurgés de l'indépendance que par les révolutionnaires du XXe siècle. La fête des morts mexicaine relève de la même logique : elle mêle traditions préhispaniques et catholiques dans une célébration où les défunts sont accueillis plutôt que pleurés.`],
    ["Les institutions coloniales et leurs suites", `Une réduction jésuite était un village organisé par les jésuites pour regrouper des populations autochtones, principalement au Paraguay et dans les régions voisines aux XVIIe et XVIIIe siècles. Ces établissements combinaient évangélisation, protection contre les chasseurs d'esclaves et organisation économique collective — expérience ambivalente, à la fois refuge et entreprise d'encadrement, qui s'acheva par l'expulsion de l'ordre.

Au XXe siècle, la théologie de la libération engage une partie du clergé latino-américain aux côtés des pauvres. Oscar Romero, archevêque de San Salvador, est assassiné en 1980 alors qu'il célébrait la messe, après avoir dénoncé publiquement la répression militaire. Il a été canonisé en 2018.`],
    ["Les recompositions actuelles", `Le pentecôtisme évangélique progresse rapidement en Amérique latine, au point de bouleverser un paysage catholique presque exclusif depuis cinq siècles. Sa croissance s'appuie sur des communautés de proximité, une place donnée aux laïcs, une promesse de guérison et de prospérité, et une implantation dans les quartiers que l'Église catholique avait délaissés.

Ce mouvement a des effets politiques directs : les électorats évangéliques pèsent désormais dans plusieurs pays, et leurs positions sur les questions de société diffèrent sensiblement de celles de la hiérarchie catholique.`],
    ["Les traditions autochtones", `Le potlatch, chez certains peuples de la côte nord-ouest américaine, est une cérémonie de don ostentatoire où l'hôte distribue ou détruit ses biens pour affirmer son rang. Interdit par le Canada et les États-Unis pendant plusieurs décennies parce qu'il contredisait la logique d'accumulation, il a été étudié par Marcel Mauss comme cas limite de l'échange.

La hutte à sudation est un rite de purification par la chaleur, pratiqué par plusieurs peuples autochtones nord-américains. Le peyotl, cactus psychotrope, est employé rituellement dans un cadre religieux encadré, avec un statut légal spécifique aux États-Unis pour ses usages traditionnels. Ces pratiques font aujourd'hui l'objet de reprises hors de leur contexte, souvent à des fins commerciales — ce que les communautés concernées dénoncent comme appropriation, en soulignant qu'un rite détaché de sa transmission cesse d'être ce qu'il était.`],
  ],

  "mr3-dialogue-conflits": [
    ["Rarement seulement religieux", `Les conflits dits religieux mêlent presque toujours des enjeux politiques, territoriaux et économiques : la religion y fournit une ligne de partage, un vocabulaire et une mobilisation, rarement la cause unique. Les historiens des guerres de Religion françaises l'ont montré depuis longtemps — la foi y était réelle, et les rivalités de familles nobiliaires, les questions fiscales et les intérêts urbains l'étaient tout autant.

Le conflit nord-irlandais en fournit un cas d'école : il recoupe une division confessionnelle, mais son objet est politique et identitaire — l'appartenance au Royaume-Uni ou à l'Irlande. Décrire ces trente années comme une guerre entre catholiques et protestants revient à confondre le marqueur et l'enjeu.`],
    ["Organiser la coexistence", `Le Liban a institué un système politique répartissant les fonctions entre communautés confessionnelles : présidence, gouvernement et parlement sont attribués selon des équilibres fixés. Ce confessionnalisme a permis une coexistence, et l'a en même temps figée : il rend toute évolution démographique politiquement explosive et enferme les citoyens dans une appartenance héritée.

Ailleurs, des lieux de culte partagés existent — espaces fréquentés par plusieurs communautés, souvent autour d'un saint ou d'une source réputée efficace. Rarement théorisés, ils relèvent d'un pragmatisme populaire que les autorités religieuses regardent avec méfiance.`],
    ["Se parler", `Le dialogue islamo-chrétien désigne des échanges organisés entre représentants des deux traditions, sur des questions théologiques, éthiques ou sociales. Du côté catholique, il a été rendu possible par la déclaration Nostra aetate du concile Vatican II, texte bref qui redéfinit les relations avec les religions non chrétiennes et reconnaît ce qu'elles contiennent de vrai et de saint.

Le même texte marque une rupture décisive sur le judaïsme : il récuse l'accusation collective de déicide portée contre les Juifs pendant des siècles, et condamne l'antisémitisme. La médiation interreligieuse, enfin, implique des responsables religieux dans des processus de paix ; son efficacité dépend de leur légitimité locale et non de leur rang institutionnel.`],
    ["Les hostilités, et la critique", `L'antisémitisme est une hostilité systématique envers les Juifs, en tant que groupe et non en tant que croyants — ce qui le distingue d'une hostilité religieuse ordinaire et explique sa persistance dans des sociétés sécularisées. L'islamophobie, telle que les organisations internationales la définissent, désigne une hostilité visant les musulmans en tant que tels ; le terme est discuté, certains lui reprochant de confondre la critique d'une religion et l'hostilité envers des personnes.
