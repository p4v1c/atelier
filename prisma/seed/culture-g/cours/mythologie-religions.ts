...
En France, la laïcité est un principe de neutralité de l'État, garantissant la liberté de conscience et l'égalité des citoyens quelle que soit leur croyance : elle n'impose rien aux individus, elle oblige la puissance publique. Enfin, les personnes sans affiliation religieuse représentent environ un sixième de la population mondiale, ce qui en ferait le troisième ensemble après le christianisme et l'islam — sans qu'il s'agisse d'un groupe homogène.`],
  ],
...
Le poète latin Lucrèce expose cette philosophie en vers dans De la nature des choses, texte perdu puis retrouvé au XVe siècle, dont la redécouverte a nourri toute la pensée moderne. Sa description du monde sans providence, faite d'atomes qui dévient, a impressionné jusqu'aux physiciens contemporains.`],
    ["Les modernes", `Spinoza est excommunié de la communauté juive d'Amsterdam en 1656 pour des idées qui identifient Dieu et la nature : sa position, souvent qualifiée de panthéiste, ôte à Dieu la personnalité, la volonté et la providence. Il publie l'essentiel de son œuvre de façon posthume ou anonyme.
