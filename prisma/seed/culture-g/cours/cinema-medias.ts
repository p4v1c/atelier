...
Presque tous les sons d'un film sont recréés en studio : le bruitage, ou foley, du nom du technicien qui en systématisa la pratique, consiste à refabriquer pas, froissements et chocs en synchronisation avec l'image, avec des objets qui n'ont souvent aucun rapport avec ce qu'on voit. Le son direct capté au tournage est le plus souvent inutilisable tel quel.`],
  ],
...
La libéralisation transforme le paysage dans les années 1980 : création de chaînes privées, puis privatisation de TF1 en 1987, opération inédite d'une chaîne publique vendue au secteur privé. En 1992 naît Arte, chaîne culturelle franco-allemande à capitaux publics, diffusée dans les deux pays.`],
    ["Diffuser et mesurer", `La TNT, télévision numérique terrestre, lancée en 2005, a remplacé la diffusion analogique, éteinte en novembre 2011 : le numérique permettant de faire passer davantage de chaînes dans la même bande de fréquences, l'offre gratuite est passée de six à une trentaine de chaînes.
...
Une source anonyme protégée est un informateur dont le journaliste connaît l'identité mais ne la révèle pas ; le secret des sources est protégé par la loi française. Le fact-checking, apparu dans les années 2000 et généralisé dans les rédactions à partir des années 2010, consiste à vérifier systématiquement des déclarations publiques et des informations en circulation, et constitue désormais un genre à part entière.`],
...
En France, la loi de 1981 met fin au monopole d'État sur la radiodiffusion et autorise les radios privées locales, longtemps appelées radios libres parce qu'elles émettaient auparavant dans l'illégalité. Depuis, le RDS transmet en parallèle du son des données comme le nom de la station et permet le suivi automatique de fréquence, et la DAB+ propose une diffusion numérique terrestre offrant plus de stations pour une même ressource hertzienne.`],
    ["Le son à la demande", `Le format MP3, mis au point dans les années 1990, compresse un fichier audio en supprimant ce que l'oreille perçoit mal : il divise le poids par dix environ et rend possible la diffusion de musique sur des connexions lentes. Il a plus bouleversé l'industrie musicale qu'aucune décision commerciale.
...
Son influence est mondiale, mais elle a été transformée en route. L'Actors Studio, école new-yorkaise fondée en 1947 et dirigée par Lee Strasberg, en tire une méthode qui insiste sur la mobilisation des émotions personnelles de l'acteur. Elle a formé Dean, De Niro, Pacino et bien d'autres — Brando, lui, a toujours nié en relever et revendiquait l'enseignement de Stella Adler — et durablement marqué le cinéma américain — au prix de dérives que plusieurs de ses élèves les plus célèbres ont critiquées.`],
...
Elle rappelle que la liberté d'expression ne se réduit pas à l'absence d'interdiction. Le code Hays américain, étudié au chapitre sur Hollywood, en est le cas d'école. Mais l'autocensure a des formes contemporaines : le retrait préventif d'un sujet sous menace de procès, le renoncement à publier une enquête faute d'assurance juridique, la prudence d'une rédaction dont l'actionnaire est partie prenante. La contrainte la plus efficace est souvent celle que l'on s'applique soi-même.`],
  ],
...
La spatialisation en salle répartit les sons entre des enceintes multiples, autour et au-dessus du public, ce qui permet de placer une source à un endroit précis de l'espace. Toute cette architecture agit largement en dessous du seuil de l'attention consciente : le spectateur croit regarder un film, et une part considérable de ce qu'il ressent lui vient par les oreilles. C'est pourquoi les professionnels disent que le son fait la moitié de l'image.`],
  ...
  "cm3-cinema-economie-mondiale": [
    ["Produire n'est pas dominer", `Le cinéma américain domine le marché mondial mais ne produit pas le plus de films : c'est l'Inde qui détient ce record, avec plus de mille cinq cents à deux mille longs métrages par an dans une vingtaine de langues. La domination américaine tient à la distribution, au marketing et à l'accès aux écrans, non au volume.

Le Nigeria constitue le troisième pôle mondial en nombre de films, avec une industrie surnommée Nollywood : production très rapide, budgets minimes, diffusion d'abord en vidéo puis en ligne. Le modèle, longtemps ignoré des statistiques officielles, fait vivre des centaines de milliers de personnes. La Chine, elle, a connu la croissance la plus rapide du siècle : d'environ deux mille écrans en 2003 à plus de quatre-vingt mille vingt ans plus tard.`],
