...
export const EUROPE = fiches([
  ...
  ["276", "DE", "Allemagne", "Berlin", "au centre du continent, de la mer du Nord aux Alpes ; neuf voisins, le record d'Europe après la Russie", "Noir, rouge, or : les couleurs des volontaires de 1813, reprises en 1848 puis en 1949."],
  ...
  ["56", "BE", "Belgique", "Bruxelles", "sur la mer du Nord, entre la France et les Pays-Bas", undefined, "Officiellement bilingue, enclavée dans la Flandre néerlandophone. Elle abrite la Commission européenne."],
  ...
  ["250", "FR", "France", "Paris", "de la Manche à la Méditerranée : le seul pays d'Europe à toucher à la fois la Manche et la Méditerranée", "Le bleu et le rouge sont les couleurs de Paris, le blanc celui de la monarchie."],
  ["300", "GR", "Grèce", "Athènes", "à la pointe sud des Balkans, avec des milliers d'îles en mer Égée", "Neuf bandes — pour les neuf syllabes de « Eleftheria i thanatos », la liberté ou la mort, dit-on.", "Habitée sans interruption depuis plus de trois mille ans, mais capitale seulement depuis 1834."],
  ["348", "HU", "Hongrie", "Budapest", "sans littoral, dans la plaine du Danube, au centre du bassin des Carpates", undefined, "Trois villes réunies en 1873 : Buda et Óbuda sur les collines, Pest sur la plaine."],
  ...
  ["428", "LV", "Lettonie", "Riga", "le pays du milieu des trois États baltes, sur le golfe de Riga", undefined, "La plus grande ville des trois États baltes, et la plus grande concentration d'Art nouveau d'Europe."],
  ...
  ["620", "PT", "Portugal", "Lisbonne", "à l'ouest de l'Espagne, sur l'Atlantique ; le pays continental le plus occidental d'Europe", "La sphère armillaire, modèle du ciel et emblème personnel de Manuel Iᵉʳ, est le symbole des Grandes Découvertes portugaises.", "Le tremblement de terre de 1755 l'a détruite aux trois quarts et a fait rebâtir son centre en damier."],
  ...
  ["703", "SK", "Slovaquie", "Bratislava", "sans littoral, entre la Tchéquie et l'Ukraine ; les Carpates en occupent tout le nord, la plaine du Danube tout le sud", undefined, "La seule capitale au monde qui touche deux pays étrangers : l'Autriche et la Hongrie."],
...
export const AFRIQUE = fiches([
  ...
  ["384", "CI", "Côte d'Ivoire", "Yamoussoukro", "sur le golfe de Guinée, entre le Libéria et le Ghana", undefined, "Capitale politique depuis 1983 ; Abidjan reste la ville économique et la plus peuplée."],
  ...
  ["180", "CD", "République démocratique du Congo", "Kinshasa", "au cœur du bassin du Congo ; le deuxième pays d'Afrique par la superficie", undefined, "Face à Brazzaville, de l'autre côté du fleuve : après Rome et le Vatican, les deux capitales les plus proches du monde."],
  ...
  ["694", "SL", "Sierra Leone", "Freetown", "sur l'Atlantique, entre la Guinée et le Libéria"],
...
export const ASIE = fiches([
  ...
  ["682", "SA", "Arabie Saoudite", "Riyad", "l'essentiel de la péninsule Arabique, entre la mer Rouge et le golfe Persique", "Il porte la profession de foi musulmane et un sabre : jamais mis en berne.", "Au centre du plateau du Nedjd, en plein désert, à quatre cents kilomètres du golfe Persique et neuf cents de la mer Rouge."],
  ...
  ["116", "KH", "Cambodge", "Phnom Penh", "entre la Thaïlande et le Viêt Nam, autour du grand lac Tonlé Sap", "Le seul drapeau national à représenter un bâtiment identifiable : les tours d'Angkor Vat."],
  ...
  ["360", "ID", "Indonésie", "Jakarta", "un archipel de dix-sept mille îles, à cheval sur l'équateur", "Rouge sur blanc — le même que celui de Monaco, en plus allongé : deux tiers contre quatre cinquièmes.", "Sur l'île de Java. Elle s'enfonce de plusieurs centimètres par an, d'où une nouvelle capitale à Bornéo."],
  ...
  ["376", "IL", "Israël", "Jérusalem", "sur la Méditerranée, entre le Liban et l'Égypte", "Les deux bandes bleues rappellent le talit, le châle de prière.", "Capitale proclamée par Israël et siège de ses institutions ; la France et la plupart des États n'y reconnaissent pas ce statut et gardent leur ambassade à Tel-Aviv."],
  ...
  ["400", "JO", "Jordanie", "Amman", "presque enclavée : vingt-six kilomètres de côte sur le golfe d'Aqaba, entre Israël, la Syrie, l'Irak et l'Arabie Saoudite"],
  ...
  ["144", "LK", "Sri Lanka", "Sri Jayawardenepura Kotte", "une île au sud-est de la pointe de l'Inde", undefined, "Capitale officielle depuis 1985 ; Colombo, sa voisine, reste la capitale économique et la plus grande ville."],
  ...
  /* La Turquie figure aussi sur la carte d'Asie (à cheval sur les deux
     continents), mais sa fiche n'est écrite qu'une fois, dans EUROPE : la
     référencer ici plutôt que la recopier garantit que les deux ne peuvent
     plus diverger. */
  .concat(EUROPE.find((f) => f.id === "792")!);
...
export const AMERIQUES = fiches([
  ...
  ["152", "CL", "Chili", "Santiago", "une bande de quatre mille kilomètres entre les Andes et le Pacifique", "Une étoile blanche dans un carré bleu ; il précède de vingt-deux ans le drapeau du Texas.", "Dans une cuvette entre deux cordillères — d'où une pollution hivernale que le relief retient."],
  ["170", "CO", "Colombie", "Bogotá", "à l'angle nord-ouest du continent, seul pays sud-américain sur deux océans", "La bande jaune occupe la moitié du drapeau ; les couleurs viennent de la Grande Colombie.", "Sur un plateau andin à deux mille six cents mètres : quinze degrés toute l'année."],
  ...
  ["600", "PY", "Paraguay", "Asunción", "sans littoral, entre la Bolivie, le Brésil et l'Argentine", "Le seul drapeau national dont les deux faces diffèrent."],
 ...
 * plus Taïwan, plutôt que les cent soixante-quatre qui se laissent dessiner.
 */
export const MONDE_RESTE = fiches([
  ["28", "AG", "Antigua-et-Barbuda", "Saint John's", "deux îles des Petites Antilles, à cent cinquante kilomètres au nord de la Guadeloupe", "Un soleil levant noir, bleu et blanc en triangle inversé sur fond rouge : le noir dit l'ascendance africaine, le soleil une ère nouvelle."],
  ["44", "BS", "Bahamas", "Nassau", "sept cents îles au nord-est de Cuba, dans l'Atlantique", "Un triangle noir au mât, entre deux bandes turquoise et une bande d'or : la mer, le sable, et la vigueur du peuple qu'incarne le triangle."],
  ["48", "BH", "Bahreïn", "Manama", "un archipel du golfe Persique, relié à l'Arabie Saoudite par une digue de vingt-cinq kilomètres", "Blanc et rouge séparés par une ligne dentelée à cinq pointes, comme les autres monarchies du Golfe : les cinq piliers de l'islam."],
  ["52", "BB", "Barbade", "Bridgetown", "la plus orientale des Petites Antilles, seule en plein Atlantique", "Bleu, or, bleu en bandes verticales : un trident noir brisé, celui de Neptune privé de son manche, dit la rupture avec la couronne britannique."],
  ["132", "CV", "Cap-Vert", "Praia", "dix îles volcaniques à cinq cents kilomètres au large du Sénégal", "Dix étoiles jaunes en cercle sur une bande blanc-rouge-blanc, dans le bleu : les dix îles principales de l'archipel."],
  ["174", "KM", "Comores", "Moroni", "un archipel du canal du Mozambique, entre Madagascar et le continent", "Quatre bandes et un croissant vert : une étoile par île, dont Mayotte, que l'archipel revendique bien qu'elle soit française."],
  ["212", "DM", "Dominique", "Roseau", "une île montagneuse des Petites Antilles, entre la Guadeloupe et la Martinique", "Un sisserou, perroquet qui ne vit que sur l'île, entouré de dix étoiles pour les dix paroisses, sur une croix tricolore et un fond vert."],
  ["242", "FJ", "Fidji", "Suva", "trois cents îles du Pacifique sud, à l'est de l'Australie", "Bleu ciel comme le Pacifique, l'Union Jack au canton pour le passé britannique, l'écu fidjien — une colombe et des productions locales — au battant."],
  ["308", "GD", "Grenade", "Saint-Georges", "au sud des Petites Antilles, à cent cinquante kilomètres de Trinité", "Sept étoiles pour sept paroisses, une noix de muscade dans le vert : l'île aux épices, l'un des tout premiers producteurs mondiaux."],
  ["296", "KI", "Kiribati", "Tarawa", "trente-trois atolls étalés sur trois fuseaux horaires, à cheval sur l'équateur et sur la ligne de changement de date", "Une frégate survole un soleil à dix-sept rayons, un par île Gilbert, au-dessus de vagues blanches : l'océan et les trois archipels du pays."],
  ["462", "MV", "Maldives", "Malé", "mille deux cents îles de l'océan Indien, au sud-ouest de l'Inde ; le pays le plus plat du monde", "Un croissant blanc sur un panneau vert cerné de rouge : le vert dit l'islam, le rouge le sang versé pour l'indépendance."],
  ["584", "MH", "Îles Marshall", "Majuro", "des atolls du Pacifique nord, à mi-chemin entre Hawaï et les Philippines", "Deux bandes obliques, orange et blanche, pour les deux chapelets d'atolls Ralik et Ratak ; une étoile à vingt-quatre branches, quatre plus longues que les autres, pour les principaux atolls."],
  ["480", "MU", "Maurice", "Port-Louis", "une île de l'océan Indien, à huit cents kilomètres à l'est de Madagascar", "Quatre bandes horizontales — rouge, bleu, jaune, vert —, dites « les quatre bandes » : la lutte, l'océan Indien, l'aube de l'indépendance, la végétation de l'île."],
  ["583", "FM", "Micronésie", "Palikir", "six cents îles du Pacifique ouest, au nord de la Nouvelle-Guinée", "Quatre étoiles blanches en losange sur bleu clair, une par État fédéré, sur le modèle du drapeau des Nations unies, qui administrait le territoire."],
  ["492", "MC", "Monaco", "Monaco", "deux kilomètres carrés sur la Méditerranée, enclavés dans la France", "Rouge sur blanc, comme celui de l'Indonésie, en plus court : quatre cinquièmes contre deux tiers."],
  ["520", "NR", "Nauru", "Yaren", "un seul atoll de vingt et un kilomètres carrés, en plein Pacifique ; le plus petit État insulaire du monde", "Une ligne jaune pour l'équateur, une étoile blanche à douze branches pour les douze tribus d'origine, sur un bleu Pacifique : l'île est juste au sud de la ligne."],
  ["585", "PW", "Palaos", "Ngerulmud", "un archipel du Pacifique ouest, à l'est des Philippines", "Une pleine lune dorée, décalée vers la hampe, sur fond bleu : le moment que la tradition juge le plus favorable à la pêche et aux récoltes."],
  ["659", "KN", "Saint-Christophe-et-Niévès", "Basseterre", "deux îles des Petites Antilles ; le plus petit État des Amériques", "Une diagonale noire bordée de jaune, entre un triangle vert et un triangle rouge, semée de deux étoiles blanches : l'espoir et la liberté."],
  ["674", "SM", "Saint-Marin", "Saint-Marin", "soixante et un kilomètres carrés enclavés dans l'Italie ; la plus ancienne république du monde", "Blanc pour la neige des sommets, bleu ciel au-dessous : au centre, les trois tours du mont Titano coiffées d'une couronne, sous la devise LIBERTAS."],
  ["670", "VC", "Saint-Vincent-et-les-Grenadines", "Kingstown", "une île et un chapelet d'îlots des Petites Antilles", "Trois losanges verts en V sur une large bande d'or, entre bleu et vert : les Gemmes des Antilles, un surnom de l'archipel."],
  ["662", "LC", "Sainte-Lucie", "Castries", "une île des Petites Antilles, juste au sud de la Martinique", "Un triangle d'or devant un triangle noir bordé de blanc, sur fond bleu : le soleil devant les deux Pitons volcaniques qui dominent l'île."],
  ["90", "SB", "Îles Salomon", "Honiara", "un millier d'îles du Pacifique sud, à l'est de la Papouasie", "Une diagonale jaune sépare un triangle bleu, la mer, d'un triangle vert, la terre ; cinq étoiles blanches pour les cinq groupes d'îles d'origine."],
  ["882", "WS", "Samoa", "Apia", "deux grandes îles du Pacifique sud, à l'est des Fidji", "La Croix du Sud en blanc sur un canton bleu, cinq étoiles sur fond rouge."],
  ["678", "ST", "São Tomé-et-Principe", "São Tomé", "deux îles du golfe de Guinée, posées sur l'équateur", "Deux étoiles noires sur la large bande jaune, une par île ; un triangle rouge au mât pour la lutte pour l'indépendance."],
  ["690", "SC", "Seychelles", "Victoria", "cent quinze îles de l'océan Indien, au nord-est de Madagascar", "Cinq bandes obliques — bleu, jaune, rouge, blanc, vert — rayonnant du mât comme un éventail : un pays neuf qui s'élance vers l'avenir."],
  ["702", "SG", "Singapour", "Singapour", "une cité-État à la pointe de la péninsule malaise, sur le détroit de Malacca", "Un croissant et cinq étoiles blanches sur un canton rouge, au-dessus du blanc : une jeune nation montante, et cinq idéaux, dont la démocratie et la paix."],
  ["626", "TL", "Timor oriental", "Dili", "la moitié est de l'île de Timor, au nord de l'Australie", "Un triangle jaune et un triangle noir emboîtés au mât, une étoile blanche au centre du noir, sur fond rouge : le colonialisme à surmonter, la paix qui guide."],
  ["776", "TO", "Tonga", "Nuku'alofa", "un archipel du Pacifique sud, au sud des Samoa", "Une croix rouge sur un canton blanc, sur fond rouge : la foi chrétienne. La Constitution de 1875 interdit expressément d'en changer le dessin."],
  ["798", "TV", "Tuvalu", "Funafuti", "neuf atolls du Pacifique ; l'un des pays les plus menacés par la montée des eaux", "Neuf étoiles jaunes disposées comme les neuf atolls de l'archipel, l'Union Jack au canton, sur un bleu clair de style océanien."],
  ["548", "VU", "Vanuatu", "Port-Vila", "quatre-vingts îles du Pacifique sud, à l'est de l'Australie", "Un Y jaune bordé de noir sépare un triangle rouge et un triangle vert ; au mât, une défense de sanglier autour de deux frondes de fougère, emblèmes mélanésiens traditionnels."],
]);
