...
export const EUROPE = fiches([
  ...
  ["756", "CH", "Suisse", "Berne", "sans littoral, au cœur des Alpes, entre la France, l'Allemagne et l'Italie", "Carré, ce qui n'arrive qu'à deux États au monde — l'autre est le Vatican.", "Ni la plus grande ville ni la plus riche : un compromis, en 1848, entre Zurich et Genève."],
...
export const AFRIQUE = fiches([
  ...
  ["231", "ET", "Éthiopie", "Addis-Abeba", "sans littoral, sur les hauts plateaux de la corne de l'Afrique", "C'est de lui que viennent les couleurs panafricaines : le pays n'a jamais été durablement colonisé.", "À deux mille cinq cents mètres, la troisième capitale la plus haute du monde. Siège de l'Union africaine."],
  ...
  ["404", "KE", "Kenya", "Nairobi", "sur l'océan Indien, à cheval sur l'équateur, au sud de l'Éthiopie", "Un bouclier et deux lances masaï : le seul drapeau national à porter une arme traditionnelle.", "À mille sept cents mètres, ce qui lui donne un climat tempéré à deux degrés de l'équateur."],
