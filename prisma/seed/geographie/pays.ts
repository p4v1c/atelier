...
export const EUROPE = fiches([
  ...
  ["756", "CH", "Suisse", "Berne", "sans littoral, au cœur des Alpes, entre la France, l'Allemagne et l'Italie", "Carré, ce qui n'arrive qu'à deux États au monde — l'autre est le Vatican.", "Ni la plus grande ville ni la plus riche : un compromis, en 1848, entre Zurich la puissante et Lucerne la vaincue du Sonderbund."],
