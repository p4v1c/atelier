...
const REPERES: Record<string, { drapeaux: string; capitales: string; situer: string }> = {
  ...
  afrique: {
    drapeaux: "Le vert-jaune-rouge vient d'Éthiopie, l'un des deux seuls pays du continent jamais durablement colonisés, avec le Libéria ; il a essaimé sur tout le continent.",
