...
const MERS: L[] = [
  ...
  ["ameriques", "ameriques", "mer-des-caraibes", "Mer des Caraïbes", "Clique sur la mer des Caraïbes.", "Fermée par un arc d'îles qui va de Cuba à Trinité. Le Gulf Stream y prend naissance avant de contourner la Floride et de traverser l'Atlantique.", 1],
