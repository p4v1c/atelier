...
export const ESPAGNOL_AVANCE: LotCartes[] = [
  {
    ...
    cartes: [
      ...
      { etranger: "¿Tiene algo para el dolor de cabeza?", francais: "Vous avez quelque chose contre le mal de tête ?" },
      { etranger: "Soy alérgico a la penicilina.", francais: "Je suis allergique à la pénicilline." },
      { etranger: "Me encuentro mal.", francais: "Je ne me sens pas bien.", note: "Encontrarse pour l'état ; sentirse est aussi correct." },
      ...
      { etranger: "¿Dónde está la farmacia de guardia?", francais: "Où est la pharmacie de garde ?" },
...

  {
    ...
    parle: true,
    cartes: [
      { etranger: "Busco un piso de dos habitaciones.", francais: "Je cherche un deux-pièces.", note: "Piso en Espagne, departamento en Amérique latine." },
      { etranger: "¿Cuánto es el alquiler?", francais: "Le loyer est de combien ?", note: "Alquiler en Espagne, renta au Mexique." },
      ...
      { etranger: "Hay mucho ruido por la noche.", francais: "Il y a beaucoup de bruit la nuit.", note: "Hay ne se met jamais au pluriel." },
      ...
      { etranger: "No funciona la calefacción.", francais: "Le chauffage ne marche pas.", note: "Funcionar pour un appareil ; trabajar ne s'emploie que pour les personnes." },
      { etranger: "¿Los gastos están incluidos?", francais: "Les charges sont comprises ?" },
      ...
      { etranger: "El casero no contesta.", francais: "Le propriétaire ne répond pas.", note: "Casero, le bailleur ; propietario est plus neutre." },
    ],
  },
    ...
    cours: {
      ...
      sections: [
        ...
        },
        {
          ...
          texte:
            "Le gérondif espagnol se forme en -ando pour les verbes en -ar, en -iendo pour les autres : hablando, comiendo, viviendo.\n\nIl marque l'action en cours, jamais un état : estoy comiendo, je suis en train de manger. On ne dit pas « estoy siendo » pour dire « je suis ».\n\nSurtout, il ne s'emploie jamais comme un nom, contrairement à l'anglais et parfois au français : « fumer est mauvais » se dit fumar es malo, avec l'infinitif, jamais « fumando es malo ».\n\nEt il ne s'emploie pas après une préposition : antes de salir, avant de sortir, avec l'infinitif là encore.",
        },
      ],
    },
    cartes: [
      ...
      { etranger: "Llevo dos horas esperando.", francais: "J'attends depuis deux heures." },
      { etranger: "Sigue lloviendo.", francais: "Il pleut toujours.", note: "Seguir + gérondif là où le français met un adverbe." },
      { etranger: "Acabo de hablar con ella.", francais: "Je viens de lui parler." },
      { etranger: "Dejé de fumar hace un año.", francais: "J'ai arrêté de fumer il y a un an." },
      ...
      { etranger: "Está a punto de salir.", francais: "Il est sur le point de sortir." },
...

  {
    ...
    parle: true,
    cartes: [
      { etranger: "según fuentes oficiales", francais: "selon des sources officielles", note: "Formule omniprésente dans la presse." },
      ...
      { etranger: "según los últimos datos", francais: "d'après les derniers chiffres", note: "Datos, les données ou les chiffres ; jamais fechas, qui sont des dates." },
      ...
      { etranger: "El acuerdo entró en vigor el lunes.", francais: "L'accord est entré en vigueur lundi." },
      { etranger: "La cifra supera las previsiones.", francais: "Le chiffre dépasse les prévisions." },
      ...
      { etranger: "Los sindicatos convocaron una manifestación.", francais: "Les syndicats ont appelé à une manifestation.", note: "Convocar, appeler à ; manifestación, sans e à la fin." },
    ],
  },

  {
    ...
    cartes: [
      ...
      { etranger: "O sea, que no vienes.", francais: "Donc, tu ne viens pas.", note: "O sea reformule ; c'est le tic de langage le plus répandu d'Espagne." },
      { etranger: "En realidad no me importa.", francais: "En fait, ça m'est égal.", note: "Importar se construit comme gustar." },
      { etranger: "Depende de cómo lo mires.", francais: "Ça dépend de comment tu le regardes." },
      { etranger: "Ni mucho menos.", francais: "Loin de là.", aussi: ["Absolument pas."], note: "Dément fortement ce qui vient d'être dit." },
