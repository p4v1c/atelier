...
export const ESPAGNOL_VERBES: LotCartes[] = [
...

  {
    ...
    cartes: [
      ...
      { etranger: "Tenemos una reunión el martes.", francais: "Nous avons une réunion mardi.", note: "El martes, avec l'article obligatoire : l'espagnol n'a pas de « mardi » nu. Los martes marque l'habitude." },
...

  {
    ...
    cartes: [
      ...
      { etranger: "Me da igual.", francais: "Ça m'est égal.", aussi: ["Peu importe."], aussiEtranger: ["Da lo mismo.", "Me da lo mismo."], note: "Me da igual et da lo mismo sont interchangeables : les deux se disent aussi bien." },
      ...
      { etranger: "Enseguida vuelvo.", francais: "Je reviens tout de suite." },
