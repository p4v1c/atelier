...
export const ESPAGNOL_FAUX_AMIS: LotCartes[] = [
...

  {
    ...
    statement:
      "Moins spectaculaires que les premiers, mais plus fréquents : ceux-là passent inaperçus et faussent la phrase entière. Certains sont même de vrais amis du français, piégés seulement par leur ressemblance avec un faux ami anglais.",
...

  {
    ...
    cartes: [
      ...
      { etranger: "Lo hice por ti.", francais: "Je l'ai fait à cause de toi.", aussi: ["Je l'ai fait en pensant à toi."], note: "Por ti : à cause de toi, en ton honneur. Para ti : pour te le donner." },
      { etranger: "Para mañana.", francais: "Pour demain.", note: "Échéance : para." },
      { etranger: "Por la mañana.", francais: "Le matin.", note: "Por + moment de la journée : por la mañana, por la tarde. En Amérique latine, en la mañana." },
