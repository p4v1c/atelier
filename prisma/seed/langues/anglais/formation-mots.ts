...
export const ANGLAIS_FORMATION_MOTS: LotCartes[] = [
...

  {
    ...
    category: "Grammaire en contexte",
    title: "Les tournures verbales qu'on confond",
    statement:
      "Need doing, need to do. Get to do, come to do. Used to, be used to doing. D'autres couples que remember/stop, où deux constructions voisines ne disent pas la même chose. (Le principe -ing/to, avec remember, stop, try, regret, go on et mean, est développé dans « Remember doing ou remember to do ».)",
    tip: "Used to et be used to se ressemblent à l'oreille et n'ont rien en commun : le premier dit une habitude passée révolue, le second un état présent.",
    difficulty: 2,
    niveau: "B2",
    oral: true,
    parle: true,
    cartes: [
      {
        etranger: "This report needs proofreading.",
        francais: "Ce rapport a besoin d'être relu.",
        note: "Need + gérondif a un sens passif : équivaut à needs to be proofread.",
      },
      {
        etranger: "You need to proofread this report.",
        francais: "Tu dois relire ce rapport.",
        note: "Need + infinitif : c'est la personne qui doit agir, pas la chose qui subit.",
      },
      {
        etranger: "I got to meet the author.",
        francais: "J'ai eu l'occasion de rencontrer l'auteur.",
        note: "Get to do, avoir la chance de. Une occasion ponctuelle.",
      },
      {
        etranger: "I came to realise he was right.",
        francais: "J'en suis venu à comprendre qu'il avait raison.",
        note: "Come to do, aboutir progressivement à un état — jamais get to do, qui dit une occasion, pas une évolution.",
      },
      {
        etranger: "I'm afraid of losing my job.",
        francais: "J'ai peur de perdre mon emploi.",
        note: "Afraid of + gérondif : la peur porte sur une conséquence possible.",
      },
      {
        etranger: "I'm afraid to ask.",
        francais: "Je n'ose pas demander.",
        note: "Afraid + infinitif : la peur empêche l'action elle-même.",
      },
      {
        etranger: "I used to live in Berlin.",
        francais: "J'habitais à Berlin, avant.",
        note: "Used to + infinitif : une habitude passée et révolue. Jamais de -ing.",
      },
      {
        etranger: "I'm used to living alone.",
        francais: "J'ai l'habitude de vivre seul.",
        note: "Be used to + gérondif : être habitué à. To est ici une préposition, pas la marque de l'infinitif.",
      },
    ],
  },
