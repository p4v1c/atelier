...
export const ANGLAIS_TRAVAIL: LotCartes[] = [
  {
    ...
    niveau: "B1",
    cartes: [
      { etranger: "Dear Ms Clarke,", francais: "Madame,", note: "Le français n'écrit pas le nom dans la formule d'appel ; l'anglais si — c'est même la marque du courriel personnalisé. Ms est neutre et sûr : Mrs suppose mariée, Miss suppose non mariée, les deux sont datés." },
      ...
      { etranger: "Thanks in advance.", francais: "Merci d'avance.", aussiEtranger: ["Thank you in advance."], note: "Courant, mais présume la réponse : dans un courriel formel, mieux vaut Thank you for your help." },
      { etranger: "I'd appreciate a quick reply.", francais: "Une réponse rapide me rendrait service.", aussi: ["Je vous serais reconnaissant d'une réponse rapide."], note: "Plus direct que I look forward to hearing from you, et parfaitement poli en anglais." },
      ...
      { etranger: "I look forward to hearing from you.", francais: "Dans l'attente de votre réponse.", note: "Look forward to + -ing, ici une préposition et non un infinitif. « Look forward to hear » est fautif." },
    ],
  },

  {
    ...
    tip: "Pour ne pas paraître brutal, l'anglais atténue avec un modal : « I'd say it's too expensive » plutôt que « It's too expensive ».",
    difficulty: 2,
    niveau: "B2",
    parle: true,
    oral: true,
    cartes: [
      ...
      { etranger: "I see what you mean, but…", francais: "Je vois ce que vous voulez dire, mais…" },
      { etranger: "Let me get back to you on that.", francais: "Je vous réponds là-dessus plus tard.", aussi: ["Je reviens vers vous là-dessus."] },
      ...
      { etranger: "What's the deadline?", francais: "C'est pour quand ?", aussi: ["Quelle est l'échéance ?"], aussiEtranger: ["When is it due?", "When do you need it by?"] },
...

  {
    ...
    cartes: [
      ...
      { etranger: "That's a long shot.", francais: "C'est un coup de poker.", aussi: ["Il y a peu de chances que ça marche."] },
      ...
      { etranger: "I can't be bothered.", francais: "Je n'ai pas le courage.", aussi: ["J'ai la flemme."], note: "Très britannique, familier." },
      { etranger: "It's a piece of cake.", francais: "C'est du gâteau.", aussi: ["C'est un jeu d'enfant."], note: "Pour dire que quelque chose est très facile." },
    ],
  },
];
