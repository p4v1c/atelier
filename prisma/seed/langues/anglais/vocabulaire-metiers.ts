...

  {
    ...
    cartes: [
      ...
      },
      {
        ...
        note: "Dans le jargon du management, goal, aim, objective, target vont du plus vague au plus précis ; hors de ce cadre, ils sont largement interchangeables.",
      },
      {
