...
export const ANGLAIS_DEBUTANT: LotCartes[] = [
  {
    ...
    tip: "Half past four, c'est quatre heures et demie : en anglais, past compte à partir de l'heure passée, jamais de l'heure à venir.",
    difficulty: 1,
    niveau: "A1",
    oral: true,
    parle: true,
    cartes: [
      { etranger: "It's half past four.", francais: "Il est quatre heures et demie.", note: "Half past + l'heure passée. Attention : le britannique familier abrège en half four — et cela veut dire quatre heures et demie, pas trois heures et demie." },
      ...
      { etranger: "The first floor, please.", francais: "Le premier étage, s'il vous plaît.", note: "Floor, l'étage — utile dans un ascenseur ou une réception d'hôtel." },
...

  {
    ...
    cartes: [
      ...
      { etranger: "We're a close family.", francais: "On est une famille très soudée." },
      { etranger: "I'm the youngest of three.", francais: "Je suis le plus jeune des trois." },
...

  {
    ...
    cartes: [
      ...
      { etranger: "Do you have a table for two?", francais: "Vous avez une table pour deux ?" },
      ...
      { etranger: "Does it contain nuts?", francais: "Est-ce qu'il y a des fruits à coque dedans ?" },
...

  {
    ...
    tip: "Taille avant couleur : a big red car, jamais a red big car.",
    difficulty: 1,
    niveau: "A1",
    oral: true,
    parle: true,
    cartes: [
      ...
      { etranger: "It's round.", francais: "C'est rond.", note: "La forme se place avant la couleur dans l'ordre des adjectifs." },
      { etranger: "It's made of wood.", francais: "C'est en bois.", note: "Made of + matière, en toute fin de description." },
    ],
  },

  {
    ...
    tip: "Le mot magique en anglais commercial est would : I would like, would you mind, would it be possible.",
    difficulty: 1,
    niveau: "A1",
    oral: true,
    parle: true,
    cartes: [
      ...
      { etranger: "It doesn't fit.", francais: "Ce n'est pas à ma taille.", aussi: ["Ça ne me va pas — c'est trop petit."], note: "Fit pour la taille ; suit pour le style. « It doesn't suit me » veut dire que ça ne me flatte pas." },
...

  {
    ...
    statement:
      "La météo est le sujet d'ouverture par excellence en anglais, et il n'est pas ironique : c'est vraiment ainsi qu'on entre en conversation. Et, juste après, la question qu'on pose à un inconnu : où est-ce, et comment y aller.",
