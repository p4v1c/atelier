...
export const ANGLAIS_CONJUGAISON: LotCartes[] = [
  {
    ...
    cours: {
      ...
      sections: [
        ...
        {
          titre: "Les verbes qui refusent le continu",
          texte:
            "Certains verbes décrivent un état, pas une action : ils ne se mettent pas au continu. Ce sont ceux de la perception (see, hear), de l'opinion (think, believe, know, understand), du sentiment (love, hate, want, need) et de la possession (have, own, belong).\n\nOn dit I know the answer, jamais « I am knowing ». La faute est immédiatement audible pour un anglophone.\n\nDeux exceptions utiles : think au sens de réfléchir accepte le continu — I'm thinking about it — et have au sens de prendre aussi : I'm having lunch. Dans les deux cas, le verbe est redevenu une action.",
        },
      ],
    },
    cartes: [
      ...
      {
        etranger: "I know the answer.",
        francais: "Je connais la réponse.",
        note: "Know décrit un état : jamais de continu. « I am knowing » n'existe pas.",
      },
      {
        etranger: "We're having lunch.",
        francais: "On est en train de déjeuner.",
        note: "Have au sens de prendre redevient une action, donc le continu est possible.",
      },
      {
...

  {
    ...
    tip: "Une date ou un « hier » ferment le passé et imposent le prétérit. Un lien avec maintenant appelle le present perfect.",
    difficulty: 3,
    niveau: "B1",
    oral: true,
    parle: true,
          ...
          visuels: [
            {
              ...
              lignes: [
                ...
                ["Je l'ai vu deux fois cette semaine.", "—", "I've seen him twice this week."],
                ["Tu as fini ?", "—", "Have you finished?"],
                ["Tu as fini quand ?", "When did you finish?", "— impossible avec when"],
                ["Elle habite ici depuis 2019.", "—", "She has lived here since 2019."],
                ["Elle y a habité dix ans.", "She lived there for ten years.", "— elle n'y habite plus"],
              ],
            },
          ],
        },
    ...
    cartes: [
      ...
      { etranger: "She didn't come.", francais: "Elle n'est pas venue.", note: "Didn't porte le passé ; come reste à l'infinitif." },
